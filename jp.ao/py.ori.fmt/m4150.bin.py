...
def main():
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20C, 1)"), scpexpr(EXPR_END)), "loc_11FC")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x64B, 1)"), scpexpr(EXPR_END)), "loc_134D")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x90, 1)"), scpexpr(EXPR_END)), "loc_1613")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FD, 1)"), scpexpr(EXPR_END)), "loc_1764")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    ChrTalk(
        0x102,
        (
            "#00103F#11Pどうやら大昔の坑道に\x01",
            "通じている縦穴みたいね……\x02\x03",

            "#00105Fもしかしたら前に閉じ込められた\x01",
            "旧鉱山方面に通じているのかも。\x02",
        )
    )
    ...
    ChrTalk(
        0x105,
        (
            "#10304F#12P彼が奇襲を仕掛けるとしたら\x01",
            "絶好の地点#4Rポイント#かもしれないね。\x02",
        )
    )
    ...
    ChrTalk(
        0x103,
        (
            "#00206F#11P……既にランディさんは\x01",
            "この先を通過していると思います。\x02\x03",

            "#00200Fですが、それほど\x01",
            "複雑な坑道ではなさそうです。\x02\x03",
    ...
    ChrTalk(
        0x105,
        "#10302F#12P──行こうか#8Rア ロ ン ジィ#。\x02",
    )
