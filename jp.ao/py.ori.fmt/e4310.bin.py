...
def main():
    ...
    ScpFunction((
        ...
        "Function_1_1B4",          # 01, 1
        "Function_2_1C7",          # 02, 2
        "Function_3_1624",         # 03, 3
        "Function_4_17D2",         # 04, 4
        "Function_5_197A",         # 05, 5
        "Function_6_1AB6",         # 06, 6
        "Function_7_1BF2",         # 07, 7
        "Function_8_1C54",         # 08, 8
        "Function_9_1CB6",         # 09, 9
        "Function_10_1D18",        # 0A, 10
        "Function_11_1D57",        # 0B, 11
        "Function_12_1DC0",        # 0C, 12
        "Function_13_208E",        # 0D, 13
        "Function_14_20E9",        # 0E, 14
        "Function_15_27CC",        # 0F, 15
        "Function_16_2809",        # 10, 16
        "Function_17_284D",        # 11, 17
        "Function_18_28AE",        # 12, 18
        "Function_19_28F7",        # 13, 19
        "Function_20_2907",        # 14, 20
        "Function_21_2974",        # 15, 21
        "Function_22_2AD4",        # 16, 22
    ))
    ...
    QueueWorkItem(0x8, 1, lambda_962)
    Sleep(500)
    BlurSwitch(0x0, 0x77FFFFFF, 0x0, 0x1, 0x0)
    OP_6F(0x79)
    Fade(500)
    ...
    QueueWorkItem(0x8, 1, lambda_A9A)
    ...
    QueueWorkItem(0xA, 1, lambda_E22)
    BlurSwitch(0x0, 0xBBFFFFFF, 0x0, 0x1, 0xA)
    CancelBlur(500)
    Sleep(500)
    Fade(500)
    ...
    QueueWorkItem(0x8, 2, lambda_1041)
    ...
    QueueWorkItem(0xA, 1, lambda_12C2)
    ...
    QueueWorkItem(0xA, 1, lambda_133C)
    ...
    QueueWorkItem(0xA, 1, lambda_13BA)
    BlurSwitch(0x0, 0xBBFFFFFF, 0x0, 0x1, 0xA)
    CancelBlur(500)
    Sleep(500)
    Sound(497, 2, 100, 0)
    ...
    def Function_3_1624(): pass

    label("Function_3_1624")
    ...
    def Function_4_17D2(): pass

    label("Function_4_17D2")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1979")
    Switch(
        (scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_IMOD), scpexpr(EXPR_END)),
        (0, "loc_1809"),
        (1, "loc_1845"),
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x1), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1AB5")
    Switch(
        (scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_IMOD), scpexpr(EXPR_END)),
        (0, "loc_19B3"),
        (1, "loc_19EF"),
        (2, "loc_1A2B"),
        (SWITCH_DEFAULT, "loc_1A67"),
    )
    ...
    def Function_6_1AB6(): pass

    label("Function_6_1AB6")

    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))

    label("loc_1AC0")

    Jc((scpexpr(EXPR_GET_RESULT, 0x1), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1BF1")
    Switch(
        (scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_IMOD), scpexpr(EXPR_END)),
        (0, "loc_1AEF"),
        (1, "loc_1B2B"),
    ...
    def Function_7_1BF2(): pass

    label("Function_7_1BF2")
    ...
    def Function_10_1D18(): pass

    label("Function_10_1D18")
    ...
    # Function_10_1D18 end

    def Function_11_1D57(): pass

    label("Function_11_1D57")
    ...
    # Function_11_1D57 end

    def Function_12_1DC0(): pass

    label("Function_12_1DC0")
    ...
    # Function_12_1DC0 end

    def Function_13_208E(): pass

    label("Function_13_208E")
    ...
    # Function_13_208E end

    def Function_14_20E9(): pass

    label("Function_14_20E9")
    ...
    QueueWorkItem(0x8, 1, lambda_2749)
    Sleep(1000)
    Sound(499, 0, 100, 0)
    ...
    QueueWorkItem(0xA, 1, lambda_278C)
    Sleep(1000)
    ...
    # Function_14_20E9 end

    def Function_15_27CC(): pass

    label("Function_15_27CC")
    ...
    # Function_15_27CC end

    def Function_16_2809(): pass

    label("Function_16_2809")
    ...
    # Function_16_2809 end

    def Function_17_284D(): pass

    label("Function_17_284D")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_28AD")
    ...
    Sleep(1000)
    Jump("Function_17_284D")

    label("loc_28AD")

    Return()

    # Function_17_284D end

    def Function_18_28AE(): pass

    label("Function_18_28AE")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_28F6")
    ...
    MoveCamera(0, 11, 0, 900)
    Sleep(800)
    Jump("Function_18_28AE")

    label("loc_28F6")

    Return()

    # Function_18_28AE end

    def Function_19_28F7(): pass

    label("Function_19_28F7")

    OP_9B(0x1, 0xFE, 0x0, 0x186A0, 0x4E20, 0x0)
    Return()

    # Function_19_28F7 end

    def Function_20_2907(): pass

    label("Function_20_2907")
    ...
    # Function_20_2907 end

    def Function_21_2974(): pass

    label("Function_21_2974")
    ...
    # Function_21_2974 end

    def Function_22_2AD4(): pass

    label("Function_22_2AD4")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_2B34")
    ...
    Sleep(1000)
    Jump("Function_22_2AD4")

    label("loc_2B34")

    Return()

    # Function_22_2AD4 end
