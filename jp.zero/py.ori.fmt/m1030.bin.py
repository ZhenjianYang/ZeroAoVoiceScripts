...
def main():
    ...
    Sepith("Sepith_A54", 0,   0,   14,  5,   3,   7,   6)
    Sepith("Sepith_A4C", 13,  0,   0,   6,   6,   5,   5)
    Sepith("Sepith_A5C", 0,   15,  0,   6,   4,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_414", 0x0000, 21, 6, 60, 4, 1, 30, 0, "bm1020", "Sepith_A54", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_284", 0x0000, 21, 6, 60, 4, 1, 25, 0, "bm1000", "Sepith_A4C", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_34C", 0x0000, 21, 6, 60, 4, 1, 30, 0, "bm1020", "Sepith_A5C", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_886")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x55, 1)"), scpexpr(EXPR_END)), "loc_80F")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9D3")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_95C")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
