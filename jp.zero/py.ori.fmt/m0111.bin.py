...
def main():
    ...
    Sepith("Sepith_246E", 1,   8,   6,   1,   1,   1,   2)
    Sepith("Sepith_2476", 0,   1,   0,   2,   0,   0,   0)
    Sepith("Sepith_2466", 1,   8,   6,   1,   1,   1,   2)
    Sepith("Sepith_247E", 1,   1,   0,   1,   1,   0,   0)
    ...
    BattleInfo(
        "BattleInfo_638", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0111", "Sepith_246E", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_7C8", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_2476", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_4A8", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0111", "Sepith_2476", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_890", 0x0000, 48, 6, 60, 6, 1, 25, 0, "bm0110", "Sepith_2466", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_A20", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_247E", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_958", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_246E", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_570", 0x0000, 48, 6, 60, 6, 1, 25, 0, "bm0111", "Sepith_2466", 30, 45, 20, 5,
        (
    ...
    ScpFunction((
        ...
        "Function_5_1473",         # 05, 5
        "Function_6_15E4",         # 06, 6
        "Function_7_1731",         # 07, 7
        "Function_8_187E",         # 08, 8
        "Function_9_19CB",         # 09, 9
        "Function_10_1B94",        # 0A, 10
        "Function_11_1D55",        # 0B, 11
        "Function_12_1F4D",        # 0C, 12
        "Function_13_2145",        # 0D, 13
        "Function_14_22D9",        # 0E, 14
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1422")
    Sound(14, 0, 100, 0)
    OP_71(0x11, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_13AB")
    ...
    def Function_5_1473(): pass

    label("Function_5_1473")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_15AD")
    Sound(14, 0, 100, 0)
    ...
    def Function_6_15E4(): pass

    label("Function_6_15E4")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_16E0")
    Sound(14, 0, 100, 0)
    OP_71(0x13, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x8B, 1)"), scpexpr(EXPR_END)), "loc_1669")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_7_1731(): pass

    label("Function_7_1731")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_182D")
    Sound(14, 0, 100, 0)
    OP_71(0x14, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_17B6")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_8_187E(): pass

    label("Function_8_187E")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10F, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_197A")
    Sound(14, 0, 100, 0)
    OP_71(0x15, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_1903")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_9_19CB(): pass

    label("Function_9_19CB")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1B8C")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 7)), scpexpr(EXPR_END)), "loc_1B26")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1AFC")
    ClearScenarioFlags(0x0, 0)
    ...
    def Function_10_1B94(): pass

    label("Function_10_1B94")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1D4D")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 0)), scpexpr(EXPR_END)), "loc_1CE4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1D2C")
    ClearScenarioFlags(0x0, 0)
    ...
    # Function_10_1B94 end

    def Function_11_1D55(): pass

    label("Function_11_1D55")
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_END)), "loc_1EC0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1F18")
    ClearScenarioFlags(0x0, 0)
    ...
    # Function_11_1D55 end

    def Function_12_1F4D(): pass

    label("Function_12_1F4D")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_213D")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_END)), "loc_20B8")
    SetMapObjFrame(0xF, "m01gim01", 0x2, "on")
    SetMapObjFrame(0x10, "m01gim01", 0x2, "on")
    Sound(138, 0, 100, 0)
    Sleep(1200)
    ...
    OP_82(0x0, 0x12C, 0xBB8, 0xC8)
    SetScenarioFlags(0x56, 1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x56, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2110")
    ClearScenarioFlags(0x0, 0)
    ...
    # Function_12_1F4D end

    def Function_13_2145(): pass

    label("Function_13_2145")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_22D1")
    Fade(500)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_222F")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_224E")
    ...
    # Function_13_2145 end

    def Function_14_22D9(): pass

    label("Function_14_22D9")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_23AC")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_23CB")
