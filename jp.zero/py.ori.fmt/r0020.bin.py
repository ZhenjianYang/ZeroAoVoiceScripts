...
def main():
    ...
    Sepith("Sepith_15FF", 4,   4,   4,   4,   0,   0,   0)
    Sepith("Sepith_15EF", 5,   2,   3,   0,   0,   3,   0)
    Sepith("Sepith_15F7", 1,   6,   0,   3,   2,   1,   1)
    Sepith("Sepith_1607", 3,   0,   2,   6,   0,   0,   2)
    Sepith("Sepith_162F", 12,  20,  10,  28,  11,  2,   5)
    ...
    BattleInfo(
        "BattleInfo_62C", 0x0000, 8, 6, 45, 6, 1, 40, 0, "br0000", "Sepith_15FF", 30, 45, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_590", 0x0000, 8, 6, 45, 6, 1, 25, 0, "br0000", "Sepith_15EF", 30, 45, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_764", 0x0000, 8, 6, 45, 6, 1, 25, 0, "br0000", "Sepith_15F7", 30, 45, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_6C8", 0x0000, 8, 6, 45, 6, 1, 75, 0, "br0000", "Sepith_1607", 30, 45, 25, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_800", 0x0000, 35, 6, 45, 6, 1, 40, 0, "br0000", "Sepith_162F", 40, 35, 25, 0,
        (
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x32, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x33, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x34, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x35, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x36, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "GetItemNumber(0x37, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_E8E")
    OP_65(0x2, 0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x100, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_10C2")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x3C, 1)"), scpexpr(EXPR_END)), "loc_104B")
    ...
    def Function_4_1113(): pass

    label("Function_4_1113")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x100, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_123F")
    Sound(14, 0, 100, 0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x78, 6)), scpexpr(EXPR_END)), "loc_12A8")
    Return()
    ...
    def Function_8_14DA(): pass

    label("Function_8_14DA")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_14F2")
    ...
    OP_5A()
    OP_6F(0x1)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_15C2")
    OP_E0(0x2)
