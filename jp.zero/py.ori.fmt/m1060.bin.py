...
def main():
    ...
    Sepith("Sepith_A9E", 6,   6,   6,   12,  2,   2,   2)
    Sepith("Sepith_A76", 13,  0,   0,   6,   6,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_364", 0x0000, 21, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_A9E", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_29C", 0x0000, 21, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_A76", 60, 25, 10, 5,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_8B0")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x68, 1)"), scpexpr(EXPR_END)), "loc_839")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9FD")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_986")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
