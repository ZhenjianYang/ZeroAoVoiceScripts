...
def main():
    ...
    Sepith("Sepith_1309", 0,   0,   22,  0,   14,  14,  0)
    Sepith("Sepith_1311", 12,  0,   0,   7,   16,  16,  0)
    Sepith("Sepith_1329", 0,   27,  0,   0,   20,  1,   2)
    Sepith("Sepith_1321", 10,  5,   5,   4,   4,   8,   15)
    Sepith("Sepith_1319", 13,  0,   8,   8,   13,  8,   0)
    ...
    BattleInfo(
        "BattleInfo_530", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_1309", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_330", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_1311", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_5F8", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_1329", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_4C0", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_1321", 50, 50, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_3F8", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2020", "Sepith_1319", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_107D")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_1006")
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_129B")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x75, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_11C9")
    ...
    QueueWorkItem(0x8, 1, lambda_1127)

    def lambda_1141():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x3E8)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_1141)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x64E, 1)"), scpexpr(EXPR_END)), "loc_1226")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
