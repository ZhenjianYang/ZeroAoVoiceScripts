...
def main():
    ...
    Sepith("Sepith_12C8", 10,  7,   0,   7,   9,   6,   9)
    Sepith("Sepith_12C0", 0,   17,  5,   0,   12,  10,  12)
    Sepith("Sepith_12B8", 7,   7,   0,   0,   9,   15,  9)
    Sepith("Sepith_12B0", 13,  0,   7,   14,  0,   4,   9)
    ...
    BattleInfo(
        "BattleInfo_3AC", 0x0000, 23, 6, 45, 6, 1, 40, 0, "bt0610", "Sepith_12C8", 65, 35, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_41C", 0x0000, 23, 6, 45, 6, 1, 25, 0, "bt0610", "Sepith_12C0", 65, 35, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_48C", 0x0000, 23, 6, 45, 6, 1, 25, 0, "bt0610", "Sepith_12B8", 65, 35, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_4FC", 0x0000, 23, 6, 45, 6, 1, 50, 0, "bt0610", "Sepith_12B0", 65, 35, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_56C", 0x0400, 23, 6, 45, 6, 1, 40, 0, "bt0610", "Sepith_12C8", 65, 35, 0, 0,
        (
            ("ms64800.dat", "ms64800.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_30C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            ("ms64800.dat", "ms64800.dat", "ms64800.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_32C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            (),
    ...
    BattleInfo(
        "BattleInfo_5DC", 0x0400, 23, 6, 45, 6, 1, 25, 0, "bt0610", "Sepith_12C0", 65, 35, 0, 0,
        (
            ("ms60800.dat", "ms60800.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_30C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            ("ms60800.dat", "ms60800.dat", "ms60800.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_32C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            (),
    ...
    BattleInfo(
        "BattleInfo_64C", 0x0400, 23, 6, 45, 6, 1, 25, 0, "bt0610", "Sepith_12B8", 65, 35, 0, 0,
        (
            ("ms65801.dat", "ms65801.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_30C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            ("ms65801.dat", "ms61701.dat", "ms65801.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_32C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            (),
    ...
    BattleInfo(
        "BattleInfo_6BC", 0x0400, 23, 6, 45, 6, 1, 50, 0, "bt0610", "Sepith_12B0", 65, 35, 0, 0,
        (
            ("ms61701.dat", "ms61701.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_30C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            ("ms61701.dat", "ms65801.dat", "ms61701.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_32C", "MonsterBattlePostion_38C", "ed7400", "ed7403", "ATBonus_2CC"),
            (),
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x114, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_CAF")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_C38")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x115, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DFC")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FB, 1)"), scpexpr(EXPR_END)), "loc_D85")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_5_E4D(): pass

    label("Function_5_E4D")
    ...
    QueueWorkItem(0x101, 1, lambda_EDB)

    def lambda_EF5():
        OP_98(0xFE, 0x0, 0x0, 0xFFFFF448, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_EF5)

    def lambda_F0F():
        OP_98(0xFE, 0x0, 0x0, 0xFFFFF448, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_F0F)

    def lambda_F29():
        OP_98(0xFE, 0x0, 0x0, 0xFFFFF448, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_F29)
    FadeToBright(1000, 0)
    OP_0D()
    ...
    QueueWorkItem(0x102, 1, lambda_F6A)

    def lambda_F77():
        OP_93(0xFE, 0x87, 0x1F4)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_F77)

    def lambda_F84():
        OP_93(0xFE, 0xE1, 0x1F4)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_F84)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x103, 1)
    WaitChrThread(0x104, 1)
