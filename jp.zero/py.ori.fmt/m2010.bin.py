...
def main():
    ...
    Sepith("Sepith_AB3", 12,  0,   0,   7,   16,  16,  0)
    Sepith("Sepith_ABB", 13,  0,   8,   8,   13,  8,   0)
    Sepith("Sepith_AC3", 10,  5,   5,   4,   4,   8,   15)
    ...
    BattleInfo(
        "BattleInfo_280", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2000", "Sepith_AB3", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_348", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2000", "Sepith_ABB", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_410", 0x0000, 30, 6, 45, 6, 1, 30, 0, "bm2000", "Sepith_AC3", 100, 0, 0, 0,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A32")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_9BB")
