...
def main():
    ...
    Sepith("Sepith_13A8", 9,   9,   9,   9,   0,   0,   19)
    Sepith("Sepith_13A0", 9,   9,   9,   9,   0,   19,  0)
    Sepith("Sepith_1398", 9,   9,   9,   9,   19,  0,   0)
    ...
    BattleInfo(
        "BattleInfo_4BC", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_13A8", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_3F4", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_13A0", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_32C", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_1398", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x112, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EEB")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_E74")
    ...
    def Function_5_F3C(): pass

    label("Function_5_F3C")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 4)), scpexpr(EXPR_END)), "loc_F85")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_113A")
    Fade(500)
    ...
    Fade(500)
    Sound(161, 0, 100, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_10CB")
    ClearScenarioFlags(0x0, 0)
    ...
    OP_0D()
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1134")
    SetMapObjFlags(0x1, 0x10)
    Jump("loc_113A")
    ...
    def Function_6_1142(): pass

    label("Function_6_1142")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 5)), scpexpr(EXPR_END)), "loc_118B")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1340")
    Fade(500)
    ...
    Fade(500)
    Sound(161, 0, 100, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_12D1")
    ClearScenarioFlags(0x0, 0)
    ...
    OP_0D()
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_133A")
    SetMapObjFlags(0x1, 0x10)
    Jump("loc_1340")
