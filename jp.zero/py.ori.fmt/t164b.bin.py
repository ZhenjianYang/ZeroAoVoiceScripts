...
def main():
    ...
    Sepith("Sepith_AA8", 13,  13,  24,  10,  0,   0,   0)
    Sepith("Sepith_AB0", 3,   14,  4,   4,   12,  12,  12)
    ...
    BattleInfo(
        "BattleInfo_29C", 0x0000, 34, 6, 60, 4, 1, 30, 0, "bt162b", "Sepith_AA8", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_364", 0x0000, 34, 6, 60, 4, 1, 40, 0, "bt162b", "Sepith_AB0", 30, 45, 20, 5,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10F, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_849")
    Sound(14, 0, 100, 0)
    OP_71(0x7, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x9B, 1)"), scpexpr(EXPR_END)), "loc_7D2")
    ...
    ChrTalk(
        ...
        (
            ...
            "#0702F#6Pフ……ようやく核心に\x01",
            "たどり着けるというわけか。\x07\x00\x02",
        )
    )
