...
def main():
    ...
    Sepith("Sepith_1158", 4,   19,  6,   4,   11,  0,   5)
    Sepith("Sepith_1160", 8,   6,   0,   4,   14,  18,  0)
    Sepith("Sepith_1150", 11,  10,  0,   7,   12,  0,   11)
    Sepith("Sepith_1148", 16,  12,  3,   9,   5,   0,   5)
    ...
    BattleInfo(
        "BattleInfo_4DC", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2000", "Sepith_1158", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_5A4", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2000", "Sepith_1160", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_414", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2000", "Sepith_1150", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_34C", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2000", "Sepith_1148", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E25")
    Sound(14, 0, 100, 0)
    OP_71(0x5, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x75, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D53")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x5EA, 1)"), scpexpr(EXPR_END)), "loc_DB0")
    ...
    def Function_5_E6B(): pass

    label("Function_5_E6B")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11C, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F67")
    Sound(14, 0, 100, 0)
    OP_71(0x6, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_EF0")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_FB8(): pass

    label("Function_6_FB8")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 2)), scpexpr(EXPR_END)), "loc_FF9")
    TalkBegin(0xFF)
    SetChrName("")
