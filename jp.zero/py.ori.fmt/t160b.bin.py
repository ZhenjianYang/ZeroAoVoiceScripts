...
def main():
    ...
    ScpFunction((
        ...
        "Function_6_A78",          # 06, 6
        "Function_7_AB6",          # 07, 7
        "Function_8_1589",         # 08, 8
        "Function_9_15FF",         # 09, 9
        "Function_10_1617",        # 0A, 10
        "Function_11_1641",        # 0B, 11
        "Function_12_16E0",        # 0C, 12
        "Function_13_179E",        # 0D, 13
        "Function_14_1CF0",        # 0E, 14
        "Function_15_25CD",        # 0F, 15
        "Function_16_25F3",        # 10, 16
        "Function_17_2BED",        # 11, 17
        "Function_18_2CB9",        # 12, 18
    ))
    ...
    AnonymousTalk(
        ...
        (
            ...
            "その研修レポートというのが\x01",
            "気難しいことで有名な\x01",
            "ラゴー教授の指導研修のものでさ。\x02\x03",

            "もう全神経を集中する勢いで\x01",
            "徹夜で書き上げたもんだから\x01",
            "正直、意識は朦朧#4Rもうろう#としてたんだ。\x02",
        )
    )
    ...
    QueueWorkItem(0x8, 1, lambda_8B1)
    WaitChrThread(0x8, 1)
    ...
    QueueWorkItem(0x8, 1, lambda_8FE)
    WaitChrThread(0x8, 1)
    ...
    def Function_3_9EC(): pass

    label("Function_3_9EC")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_A0A")
    ...
    QueueWorkItem(0xFE, 1, lambda_A35)

    def lambda_A4A():
        OP_A7(0xFE, 0x37, 0x37, 0x37, 0xFF, 0x2BC)
        ExitThread()

    QueueWorkItem(0xFE, 2, lambda_A4A)
    ...
    def Function_6_A78(): pass

    label("Function_6_A78")
    ...
    QueueWorkItem(0x101, 1, lambda_D9A)

    def lambda_DB4():
        OP_95(0xFE, 6870, 7000, 10580, 2000, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_DB4)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_DEB)
    Sleep(50)
    ...
    QueueWorkItem(0x106, 1, lambda_E08)
    ...
    QueueWorkItem(0xE, 1, lambda_F2A)
    Sleep(200)
    ...
    QueueWorkItem(0xF, 1, lambda_F42)
    Sleep(100)
    ...
    QueueWorkItem(0x10, 1, lambda_F5A)
    Sleep(160)
    ...
    QueueWorkItem(0x11, 1, lambda_F72)
    Sleep(500)
    ...
    QueueWorkItem(0xC, 1, lambda_F8A)
    Sleep(300)
    ...
    QueueWorkItem(0xD, 1, lambda_FA7)
    WaitChrThread(0xC, 1)
    WaitChrThread(0xD, 1)
    WaitChrThread(0xE, 1)
    WaitChrThread(0xF, 1)
    ...
    ChrTalk(
        0xC,
        (
            "#1304F#5P大丈夫、大丈夫だからね。\x02\x03",

            "#1301Fさあ、しっかり掴まっていて。\x02\x03",
    ...
    QueueWorkItem(0xE, 1, lambda_10BB)
    Sleep(160)
    ...
    QueueWorkItem(0xF, 1, lambda_10D3)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_1103)
    SetCameraDistance(23250, 10000)
    WaitChrThread(0xE, 1)
    WaitChrThread(0xF, 1)
    WaitChrThread(0x10, 1)
    ...
    ChrTalk(
        0xC,
        (
            "#1301F#11P（……逃げ切るのは難しそうね。）\x02\x03",

            "（でも上手くやれば\x01",
            "  この子だけでも建物の中に……）\x02\x03",

            "#1303F（お父さん、お母さん、イリア……）\x02\x03",
    ...
    QueueWorkItem(0xC, 1, lambda_1296)

    def lambda_12A3():
        TurnDirection(0xFE, 0x101, 500)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_12A3)
    StopBGM(0x1F4)
    WaitBGM()
    Sleep(10)
    PlayBGM("ed7402", 0)
    ...
    QueueWorkItem(0x102, 1, lambda_13FC)

    def lambda_1416():
        OP_95(0xFE, 13910, 7000, -10360, 4000, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_1416)

    def lambda_1430():
        OP_95(0xFE, 12240, 7000, -12520, 4000, 0x0)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_1430)

    def lambda_144A():
        OP_95(0xFE, 13940, 7000, -8820, 4000, 0x0)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_144A)
    ...
    ChrTalk(
        ...
        (
            ...
            "#0707F#5P巻き込まれぬよう\x01",
            "気を付けるがいい……！\x07\x00\x02",
        )
    )
    ...
    def Function_8_1589(): pass

    label("Function_8_1589")
    ...
    QueueWorkItem(0xFE, 1, lambda_158E)
    ...
    def Function_9_15FF(): pass

    label("Function_9_15FF")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1616")
    OP_A0(0xFE, 1250, 0x0, 0xFB)
    Jump("Function_9_15FF")
    ...
    def Function_10_1617(): pass

    label("Function_10_1617")
    ...
    QueueWorkItem(0xFE, 1, lambda_1628)
    WaitChrThread(0xFE, 1)
    Return()

    # Function_10_1617 end
    ...
    QueueWorkItem(0xFE, 0, lambda_169A)
    SetChrChipByIndex(0xFE, 0x22)
    SetChrSubChip(0xFE, 0x0)
    ...
    QueueWorkItem(0xFE, 1, lambda_16B3)
    WaitChrThread(0xFE, 1)
    ...
    def Function_12_16E0(): pass

    label("Function_12_16E0")
    ...
    ChrTalk(
        ...
        (
            ...
            "#0008F#6P本当に……無事でよかった。\x02\x03",

            "#0006Fセシル姉に何かあったら俺、\x01",
            "兄貴に何て詫びたらいいのか……\x02",
        )
    )
    ...
    QueueWorkItem(0xD, 2, lambda_1A78)

    #C0022
    ChrTalk(
        0xD,
        "#11P#40Wコホッ、コホコホッ……\x02",
    )
    ...
    ChrTalk(
        0xC,
        (
            "#1303F#5P発作が出ちゃったのね……\x02\x03",

            "#1300Fミハイル君、部屋に戻って\x01",
            "お薬を飲みましょう。\x02",
        )
    )
    ...
    def Function_14_1CF0(): pass

    label("Function_14_1CF0")
    ...
    QueueWorkItem2(0x101, 1, lambda_231C)
    ...
    QueueWorkItem2(0x102, 1, lambda_232E)
    ...
    QueueWorkItem2(0x103, 1, lambda_2340)
    ...
    QueueWorkItem2(0x104, 1, lambda_2352)
    ...
    QueueWorkItem2(0x106, 1, lambda_2364)
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x3),
            "#0700F#5P魔獣を率いた謎の男か……\x02\x03",

            "お前たち、心当たりはあるか？\x07\x00\x02",
        )
    )
    ...
    QueueWorkItem(0x101, 1, lambda_2455)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_2465)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_2475)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_2485)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x103, 1)
    WaitChrThread(0x104, 1)
    ...
    ChrTalk(
        0x104,
        (
            "#0303F#11P何者かは知らねぇが……\x01",
            "とッ捕まえる必要があるな。\x02\x03",

            "#0301F何とか４階に上がってみようぜ。\x02",
        )
    )
    ...
    # Function_14_1CF0 end

    def Function_15_25CD(): pass

    label("Function_15_25CD")
    ...
    QueueWorkItem(0xFE, 1, lambda_25D9)
    WaitChrThread(0xFE, 1)
    Return()

    # Function_15_25CD end

    def Function_16_25F3(): pass

    label("Function_16_25F3")
    ...
    ChrTalk(
        0x103,
        (
            "#0208F#11P……そうですね……\x02\x03",

            "#0201Fあの秘書さんの予告では\x01",
            "まだ何かあるみたいですし……\x02",
        )
    )
    ...
    QueueWorkItem(0x102, 1, lambda_2861)
    Sleep(100)
    ...
    QueueWorkItem(0x103, 1, lambda_2871)

    def lambda_287E():
        TurnDirection(0xFE, 0x106, 300)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_287E)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x103, 1)
    WaitChrThread(0x104, 1)
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x3),
            "#0702F#11Pクク、これ以上\x01",
            "付き合う義理はあるまい。\x02\x03",

            "ツァオへの報告は十分だし、\x01",
            "私は私で守るべきものがある。\x02\x03",

            "お前たちと同じようにな。\x07\x00\x02",
        )
    )
    ...
    ChrTalk(
        ...
        (
            scpstr(SCPSTR_CODE_COLOR, 0x3),
            "#0702F#5P#20Aフ……さらばだ。\x07\x00\x02",
        )
    )
    #Auto
    ...
    QueueWorkItem(0x106, 1, lambda_2A93)
    WaitChrThread(0x106, 1)
    Fade(500)
    ...
    AnonymousTalk(
        ...
        (
            ...
            "その後、ソーニャやノエルと合流した\x01",
            "ロイドたちは手早く事情を説明し……\x02\x03",

            "警備隊の車両でクロスベル市まで\x01",
            "送ってもらえることになった。\x07\x00\x02",
        )
    )
    ...
    # Function_16_25F3 end

    def Function_17_2BED(): pass

    label("Function_17_2BED")
    ...
    QueueWorkItem(0xFE, 1, lambda_2C1B)
    WaitChrThread(0xFE, 1)
    EndChrThread(0xFE, 0x0)
    ...
    QueueWorkItem(0xFE, 1, lambda_2C55)
    WaitChrThread(0xFE, 1)
    SetChrSubChip(0xFE, 0x2)
    Sound(854, 0, 100, 0)
    ...
    QueueWorkItem(0xFE, 1, lambda_2C80)
    WaitChrThread(0xFE, 1)
    SetChrChip(0x1, 0xFE, 0x0, 0x0)
    SetChrFlags(0xFE, 0x1)
    ...
    # Function_17_2BED end

    def Function_18_2CB9(): pass

    label("Function_18_2CB9")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_2CD0")
    OP_A0(0xFE, 3000, 0x0, 0xFB)
    Jump("Function_18_2CB9")

    label("loc_2CD0")

    Return()

    # Function_18_2CB9 end
