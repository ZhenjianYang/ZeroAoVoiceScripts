...
def main():
    ...
    Sepith("Sepith_B00", 0,   2,   16,  10,  4,   3,   5)
    Sepith("Sepith_B10", 8,   15,  9,   10,  0,   0,   0)
    Sepith("Sepith_B08", 8,   6,   0,   12,  5,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_2C8", 0x0000, 25, 6, 60, 6, 1, 30, 0, "br3100", "Sepith_B00", 50, 50, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_3A8", 0x0000, 25, 6, 60, 6, 1, 30, 0, "br3100", "Sepith_B10", 50, 50, 0, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_338", 0x0000, 25, 6, 60, 6, 1, 30, 0, "br3100", "Sepith_B08", 50, 50, 0, 0,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x108, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7CD")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_756")
    ...
    def Function_3_81E(): pass

    label("Function_3_81E")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x108, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_91A")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x35, 1)"), scpexpr(EXPR_END)), "loc_8A3")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_4_96B(): pass

    label("Function_4_96B")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x108, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A67")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_9F0")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
