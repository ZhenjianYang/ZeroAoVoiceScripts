...
def main():
    ...
    Sepith("Sepith_1142", 4,   19,  9,   16,  4,   4,   8)
    Sepith("Sepith_113A", 15,  9,   14,  5,   3,   0,   14)
    Sepith("Sepith_1132", 9,   12,  6,   16,  2,   13,  4)
    ...
    BattleInfo(
        "BattleInfo_438", 0x0000, 38, 6, 60, 4, 1, 40, 0, "bm3010", "Sepith_1142", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_500", 0x0000, 38, 6, 60, 4, 1, 30, 0, "bm3010", "Sepith_113A", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_370", 0x0000, 38, 6, 60, 4, 1, 40, 0, "bm3010", "Sepith_1132", 60, 25, 10, 5,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x109, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_CB5")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x76, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BE3")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x3F3, 1)"), scpexpr(EXPR_END)), "loc_C40")
    ...
    def Function_4_CFB(): pass

    label("Function_4_CFB")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x109, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DF7")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_D80")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_5_E48(): pass

    label("Function_5_E48")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x109, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F44")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_ECD")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_F95(): pass

    label("Function_6_F95")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x109, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1091")
    Sound(14, 0, 100, 0)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_101A")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
