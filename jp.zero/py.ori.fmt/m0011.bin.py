...
def main():
    ...
    Sepith("Sepith_2B0A", 14,  2,   10,  8,   2,   2,   0)
    Sepith("Sepith_2AFA", 4,   10,  14,  5,   2,   0,   2)
    Sepith("Sepith_2B12", 0,   0,   0,   14,  8,   8,   8)
    Sepith("Sepith_2B02", 7,   14,  6,   4,   0,   3,   3)
    ...
    BattleInfo(
        "BattleInfo_8A4", 0x0000, 22, 6, 45, 4, 1, 25, 0, "bm0010", "Sepith_2B0A", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_808", 0x0000, 22, 6, 45, 4, 1, 30, 0, "bm0010", "Sepith_2AFA", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_940", 0x0000, 22, 6, 45, 4, 1, 40, 0, "bm0010", "Sepith_2B12", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_4FC", 0x0000, 22, 6, 45, 4, 1, 40, 0, "bm0011", "Sepith_2B02", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_634", 0x0000, 22, 6, 45, 4, 1, 25, 0, "bm0011", "Sepith_2B0A", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_BB0", 0x0000, 22, 6, 45, 4, 1, 40, 0, "bm0013", "Sepith_2B12", 60, 30, 10, 0,
        (
            ("ms75500.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_49C", "MonsterBattlePostion_4BC", "ed7400", "ed7403", "ATBonus_3FC"),
            ("ms75500.dat", "ms75500.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_47C", "MonsterBattlePostion_4BC", "ed7400", "ed7403", "ATBonus_3FC"),
            ("ms75500.dat", "ms75500.dat", "ms75500.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_49C", "MonsterBattlePostion_4BC", "ed7400", "ed7403", "ATBonus_3FC"),
    ...
    BattleInfo(
        "BattleInfo_9DC", 0x0000, 22, 6, 45, 4, 1, 40, 0, "bm0013", "Sepith_2B02", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_598", 0x0000, 22, 6, 45, 4, 1, 30, 0, "bm0011", "Sepith_2AFA", 60, 30, 10, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_6D0", 0x0000, 22, 6, 45, 4, 1, 40, 0, "bm0011", "Sepith_2B12", 60, 30, 10, 0,
        (
    ...
    ScpFunction((
        ...
        "Function_6_190F",         # 06, 6
        "Function_7_1A5C",         # 07, 7
        "Function_8_1C6F",         # 08, 8
        "Function_9_1E01",         # 09, 9
        "Function_10_1F48",        # 0A, 10
        "Function_11_20DA",        # 0B, 11
        "Function_12_2221",        # 0C, 12
        "Function_13_23A5",        # 0D, 13
        "Function_14_2542",        # 0E, 14
        "Function_15_26D7",        # 0F, 15
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10B, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_18BE")
    Sound(14, 0, 100, 0)
    OP_71(0x12, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_1847")
    ...
    def Function_6_190F(): pass

    label("Function_6_190F")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10B, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1A0B")
    Sound(14, 0, 100, 0)
    OP_71(0x13, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x649, 1)"), scpexpr(EXPR_END)), "loc_1994")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_7_1A5C(): pass

    label("Function_7_1A5C")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10B, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1C29")
    Sound(14, 0, 100, 0)
    OP_71(0x14, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x75, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B57")
    ...
    QueueWorkItem(0x8, 1, lambda_1AB5)

    def lambda_1ACF():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x3E8)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_1ACF)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x7E, 1)"), scpexpr(EXPR_END)), "loc_1BB4")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_8_1C6F(): pass

    label("Function_8_1C6F")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1D59")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1D78")
    ...
    def Function_9_1E01(): pass

    label("Function_9_1E01")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1ED4")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1EF3")
    ...
    def Function_10_1F48(): pass

    label("Function_10_1F48")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2032")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2051")
    ...
    # Function_10_1F48 end

    def Function_11_20DA(): pass

    label("Function_11_20DA")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_21AD")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_21CC")
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x54, 2)), scpexpr(EXPR_END)), "loc_2268")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_239D")
    Fade(500)
    ...
    def Function_13_23A5(): pass

    label("Function_13_23A5")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x54, 3)), scpexpr(EXPR_END)), "loc_23EC")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_253A")
    Fade(500)
    ...
    # Function_13_23A5 end

    def Function_14_2542(): pass

    label("Function_14_2542")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x54, 4)), scpexpr(EXPR_END)), "loc_2589")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    # Function_14_2542 end

    def Function_15_26D7(): pass

    label("Function_15_26D7")
    ...
    QueueWorkItem(0x101, 1, lambda_275C)

    def lambda_2776():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2776)
    Sleep(400)
    ...
    QueueWorkItem(0x103, 1, lambda_278A)

    def lambda_27A4():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x103, 2, lambda_27A4)
    ...
    QueueWorkItem(0x101, 1, lambda_283D)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_285A)
    OP_6F(0x50)
    Fade(500)
    ...
    ChrTalk(
        0x103,
        (
            "#0203F……過去の事例を発見。\x02\x03",

            "#0201Fどうやら誤作動で\x01",
            "動いている可能性が高そうです。\x02\x03",
