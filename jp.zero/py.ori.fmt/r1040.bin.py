...
def main():
    ...
    Sepith("Sepith_15CB", 4,   2,   11,  0,   0,   8,   5)
    Sepith("Sepith_15F3", 2,   1,   0,   0,   9,   9,   9)
    Sepith("Sepith_1603", 4,   4,   10,  2,   0,   5,   5)
    Sepith("Sepith_15D3", 0,   8,   0,   12,  4,   8,   0)
    Sepith("Sepith_15EB", 0,   0,   13,  1,   5,   7,   4)
    Sepith("Sepith_160B", 40,  40,  40,  40,  40,  40,  40)
    Sepith("Sepith_1613", 12,  7,   4,   3,   6,   14,  7)
    ...
    BattleInfo(
        "BattleInfo_714", 0x0000, 17, 6, 60, 8, 1, 50, 0, "br1000", "Sepith_15CB", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_64C", 0x0000, 17, 6, 60, 8, 1, 50, 0, "br1000", "Sepith_15F3", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_584", 0x0000, 17, 6, 60, 8, 1, 25, 0, "br1000", "Sepith_1603", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_3F4", 0x0000, 17, 6, 60, 8, 1, 40, 0, "br1000", "Sepith_15D3", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_4BC", 0x0000, 17, 6, 60, 8, 1, 25, 0, "br1000", "Sepith_15EB", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_7DC", 0x0000, 14, 6, 90, 8, 1, 50, 0, "br1000", "Sepith_160B", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_8A4", 0x0000, 35, 6, 45, 6, 1, 30, 0, "br1000", "Sepith_1613", 40, 35, 25, 0,
        (
    ...
    ScpFunction((
        ...
        "Function_3_139D",         # 03, 3
        "Function_4_14EA",         # 04, 4
        "Function_5_14FE",         # 05, 5
        "Function_6_152D",         # 06, 6
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x119, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_134C")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x38E, 1)"), scpexpr(EXPR_END)), "loc_12D5")
    ...
    def Function_3_139D(): pass

    label("Function_3_139D")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x119, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1499")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_1422")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_4_14EA(): pass

    label("Function_4_14EA")
    ...
    def Function_5_14FE(): pass

    label("Function_5_14FE")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_1516")
    SetChrFlags(0x10, 0x80)
    SetChrFlags(0x11, 0x80)

    label("loc_1516")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x7C, 0)), scpexpr(EXPR_END)), "loc_1527")
    ClearScenarioFlags(0x7C, 0)
    Jump("loc_152C")
    ...
    def Function_6_152D(): pass

    label("Function_6_152D")
