...
def main():
    ...
    Sepith("Sepith_6C5", 13,  0,   0,   6,   6,   5,   5)
    Sepith("Sepith_6ED", 6,   6,   6,   12,  2,   2,   2)
    ...
    BattleInfo(
        "BattleInfo_238", 0x0000, 21, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_6C5", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_300", 0x0000, 21, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_6ED", 40, 30, 20, 10,
        (
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_67F")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x0, 0x1E)
