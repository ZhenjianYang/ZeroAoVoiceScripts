...
def main():
    ...
    Sepith("Sepith_10C2", 12,  0,   0,   8,   18,  10,  16)
    Sepith("Sepith_10EA", 5,   18,  5,   5,   12,  12,  12)
    Sepith("Sepith_10E2", 7,   7,   14,  7,   9,   12,  12)
    ...
    BattleInfo(
        "BattleInfo_334", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_10C2", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_3FC", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_10EA", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_4C4", 0x0000, 43, 6, 60, 4, 1, 60, 0, "bm3030", "Sepith_10E2", 60, 25, 10, 5,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x101, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C89")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_C12")
    ...
    def Function_4_CDA(): pass

    label("Function_4_CDA")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x101, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EA7")
    Sound(14, 0, 100, 0)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x77, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DD5")
    ...
    QueueWorkItem(0x8, 2, lambda_D4D)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x5ED, 1)"), scpexpr(EXPR_END)), "loc_E32")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_5_EED(): pass

    label("Function_5_EED")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x119, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_FE9")
    Sound(14, 0, 100, 0)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_F72")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
