...
def main():
    ...
    Sepith("Sepith_D2E", 6,   6,   6,   12,  2,   2,   2)
    Sepith("Sepith_D26", 4,   4,   0,   0,   9,   9,   9)
    Sepith("Sepith_D1E", 6,   6,   15,  9,   0,   0,   0)
    Sepith("Sepith_D06", 13,  0,   0,   6,   6,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_3D0", 0x0000, 21, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_D2E", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_560", 0x0000, 21, 6, 60, 8, 1, 25, 0, "bm1040", "Sepith_D26", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_498", 0x0000, 21, 6, 60, 8, 1, 25, 0, "bm1040", "Sepith_D1E", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_308", 0x0000, 21, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_D06", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B4B")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x75, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A79")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x46, 1)"), scpexpr(EXPR_END)), "loc_AD6")
    ...
    def Function_4_B91(): pass

    label("Function_4_B91")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C8D")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_C16")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
