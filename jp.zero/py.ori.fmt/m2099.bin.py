...
def main():
    ...
    ScpFunction((
        ...
        "Function_3_4F7",          # 03, 3
        "Function_4_602",          # 04, 4
        "Function_5_1193",         # 05, 5
        "Function_6_11B8",         # 06, 6
        "Function_7_11D5",         # 07, 7
        "Function_8_120E",         # 08, 8
        "Function_9_15D0",         # 09, 9
    ))
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_600")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_6A9)
    Sleep(50)
    ...
    QueueWorkItem(0x109, 1, lambda_6C6)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_6E3)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_700)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_71D)
    ...
    QueueWorkItem(0x101, 1, lambda_A14)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_A24)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_A34)
    Sleep(50)
    ...
    QueueWorkItem(0x109, 1, lambda_A44)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x104, 1)
    WaitChrThread(0x109, 1)
    ...
    ChrTalk(
        0x103,
        (
            "#0208F#12P……どうやらこの場所は\x01",
            "何らかの《儀式の間》だった\x01",
            "可能性が高いかもしれません。\x02\x03",
    ...
    ChrTalk(
        0x103,
        (
            "#0206F#12Pええ……赤黒く見える染みの跡は\x01",
            "多分、血糊ではないかと。\x02\x03",

            "#0201F成分を分析してみないと\x01",
            "正確なことは分かりませんが……\x02",
        )
    )
    ...
    QueueWorkItem(0x101, 1, lambda_CDB)
    Sleep(50)
    ...
    QueueWorkItem(0x109, 1, lambda_CEB)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_CFB)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_D0B)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_D1B)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x103, 1)
    WaitChrThread(0x104, 1)
    ...
    QueueWorkItem(0x102, 1, lambda_F78)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_F90)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_FA8)
    Sleep(50)
    ...
    QueueWorkItem(0x109, 1, lambda_FC0)
    WaitChrThread(0x101, 1)
    WaitChrThread(0x102, 1)
    WaitChrThread(0x103, 1)
    WaitChrThread(0x104, 1)
    ...
    ChrTalk(
        0x104,
        (
            "#0310F#12P#Nおいおい、俺たちゃ教会の\x01",
            "悪魔祓い師#10Rエ ク ソ シ ス ト#じゃねえんだぞ！？\x02",
        )
    )
    ...
    def Function_7_11D5(): pass

    label("Function_7_11D5")
    ...
    QueueWorkItem(0xFE, 1, lambda_11DF)

    def lambda_11F9():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1194)
        ExitThread()

    QueueWorkItem(0xFE, 2, lambda_11F9)
    ...
    def Function_8_120E(): pass

    label("Function_8_120E")
    ...
    ChrTalk(
        0x102,
        (
            "#0106F#6P#Nい、今の……何だったの？\x02\x03",

            "#0101F教会の聖典に伝えられている\x01",
            "“悪魔”みたいだったけど……\x02",
        )
    )
    ...
    ChrTalk(
        0x104,
        (
            "#0303F#12P亡霊、骸骨、化物ときて、\x01",
            "最後には悪魔まで出やがったか……\x02\x03",

            "#0301F一体どうなってんだ、この遺跡は……？\x02",
        )
    )
    ...
    ChrTalk(
        0x101,
        (
            "#0001F#5P……多分、位置的に\x01",
            "あの上が鐘楼になるはずだ。\x02\x03",
    ...
    def Function_9_15D0(): pass

    label("Function_9_15D0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x79, 1)), scpexpr(EXPR_END)), "loc_15DA")
    Return()
    ...
    OP_5A()
    AddItemNumber(0xB, 1)
    Jc((scpexpr(EXPR_EXEC_OP, "GetPartyIndex(0x9)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_GTR), scpexpr(EXPR_EXEC_OP, "GetPartyIndex(0x8)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_GTR), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_18E8")
    ClearChrFlags(0x4, 0x80)
    ClearChrBattleFlags(0x4, 0x8000)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetPartyIndex(0x9)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_18D2")
    ...
    OP_0D()
    Sleep(400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD8, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_198E")
    ...
    ChrTalk(
        0x104,
        (
            "#6P#0303Fクラフトを組み合わせた戦い方について\x01",
            "記されているようだな。\x02\x03",

            "#0300Fお嬢とティオすけの技が\x01",
            "ここに書かれているものに\x01",
            "近いんじゃねえか？\x02",
        )
    )
    ...
    ChrTalk(
        0x102,
        (
            "#11P#0105Fあら……確かにそうみたいね。\x02\x03",

            "#0100Fティオちゃん、ちょっと試してみる？\x02",
        )
    )
    ...
    FadeToDark(1000, 0, -1)
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "GetPartyIndex(0x9)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_GTR), scpexpr(EXPR_EXEC_OP, "GetPartyIndex(0x8)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_GTR), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1B40")
    SetChrFlags(0x4, 0x80)
    SetChrBattleFlags(0x4, 0x8000)
