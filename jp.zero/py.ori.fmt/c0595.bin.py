...
def main():
    ...
    Sepith("Sepith_11EC", 0,   10,  20,  5,   20,  0,   0)
    Sepith("Sepith_11E4", 16,  0,   0,   0,   12,  12,  12)
    Sepith("Sepith_11DC", 0,   15,  0,   20,  20,  0,   0)
    Sepith("Sepith_11D4", 12,  7,   0,   18,  0,   0,   18)
    ...
    BattleInfo(
        "BattleInfo_3D8", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_11EC", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_568", 0x0000, 33, 6, 60, 4, 1, 30, 0, "bc0540", "Sepith_11E4", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_4A0", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_11DC", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_310", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0540", "Sepith_11D4", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x113, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D63")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x84, 1)"), scpexpr(EXPR_END)), "loc_CEC")
    ...
    def Function_3_DB4(): pass

    label("Function_3_DB4")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_E93")
    Fade(500)
    ...
    def Function_4_E9B(): pass

    label("Function_4_E9B")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_F7A")
    Fade(500)
    ...
    def Function_5_F82(): pass

    label("Function_5_F82")

    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 3)), scpexpr(EXPR_END)), "loc_109F")
    Fade(500)
    Sound(140, 0, 100, 0)
    SetMapObjFrame(0xFF, "lgt1_add", 0x1, 0x1)
    SetMapObjFrame(0xFF, "lgt2_add", 0x0, 0x1)
