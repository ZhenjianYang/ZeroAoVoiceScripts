...
def main():
    ...
    Sepith("Sepith_1543", 0,   12,  6,   0,   7,   5,   0)
    Sepith("Sepith_154B", 6,   12,  0,   3,   0,   6,   2)
    Sepith("Sepith_155B", 4,   0,   1,   10,  5,   3,   0)
    Sepith("Sepith_1563", 10,  2,   0,   4,   0,   5,   2)
    Sepith("Sepith_1553", 12,  20,  10,  28,  11,  2,   5)
    ...
    BattleInfo(
        "BattleInfo_694", 0x0000, 15, 6, 45, 6, 1, 25, 0, "br0000", "Sepith_1543", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_75C", 0x0000, 15, 6, 45, 6, 1, 15, 0, "br0000", "Sepith_154B", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_504", 0x0000, 15, 6, 45, 6, 1, 40, 0, "br0000", "Sepith_155B", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_5CC", 0x0010, 15, 6, 90, 6, 1, 5, 0, "br0000", "Sepith_1563", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_868", 0x0000, 35, 6, 45, 6, 1, 40, 0, "br0000", "Sepith_1553", 40, 35, 25, 0,
        (
    ...
    ScpFunction((
        ...
        "Function_3_D82",          # 03, 3
        "Function_4_ECF",          # 04, 4
        "Function_5_101C",         # 05, 5
        "Function_6_1169",         # 06, 6
        "Function_7_117D",         # 07, 7
        "Function_8_1191",         # 08, 8
        "Function_9_13CD",         # 09, 9
        "Function_10_13EB",        # 0A, 10
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x100, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E7E")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0xA8, 1)"), scpexpr(EXPR_END)), "loc_E07")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x100, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_FCB")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F8, 1)"), scpexpr(EXPR_END)), "loc_F54")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_5_101C(): pass

    label("Function_5_101C")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x101, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1118")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_10A1")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_1169(): pass

    label("Function_6_1169")
    ...
    def Function_7_117D(): pass

    label("Function_7_117D")
    ...
    def Function_8_1191(): pass

    label("Function_8_1191")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x78, 3)), scpexpr(EXPR_END)), "loc_119B")
    Return()
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_13EA")
    ...
    def Function_10_13EB(): pass

    label("Function_10_13EB")
    ...
    QueueWorkItem(0x8, 1, lambda_14C0)
    Sleep(6000)
    FadeToDark(1000, 0, -1)
    OP_0D()
