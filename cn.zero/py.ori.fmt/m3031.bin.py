...
def main():
    ...
    Sepith("Sepith_F41", 12,  0,   0,   8,   18,  10,  16)
    Sepith("Sepith_F49", 9,   9,   9,   9,   10,  10,  10)
    Sepith("Sepith_F61", 7,   7,   14,  7,   9,   12,  12)
    Sepith("Sepith_F69", 5,   18,  5,   5,   12,  12,  12)
    ...
    BattleInfo(
        "BattleInfo_2F0", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_F41", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_548", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3030", "Sepith_F49", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_480", 0x0000, 43, 6, 60, 4, 1, 60, 0, "bm3030", "Sepith_F61", 60, 25, 10, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_3B8", 0x0000, 43, 6, 60, 4, 1, 30, 0, "bm3040", "Sepith_F69", 60, 25, 10, 5,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BEC")
    Sound(14, 0, 100, 0)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_B7E")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D22")
    Sound(14, 0, 100, 0)
    OP_71(0x5, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F9, 1)"), scpexpr(EXPR_END)), "loc_CB4")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_4_D6B(): pass

    label("Function_4_D6B")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xF5, 5)), scpexpr(EXPR_END)), "loc_DA8")
    TalkBegin(0xFF)
    SetChrName("")
