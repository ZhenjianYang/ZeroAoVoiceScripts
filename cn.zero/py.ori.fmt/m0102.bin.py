...
def main():
    ...
    ScpFunction((
        ...
        "Function_8_F57",          # 08, 8
        "Function_9_FB7",          # 09, 9
        "Function_10_1017",        # 0A, 10
        "Function_11_1077",        # 0B, 11
    ))
    ...
    def Function_6_7DD(): pass

    label("Function_6_7DD")
    ...
    QueueWorkItem(0x104, 1, lambda_94C)
    Sleep(50)
    ...
    QueueWorkItem(0x103, 1, lambda_969)
    OP_68(0, 800, 0, 3500)
    FadeToBright(1000, 0)
    OP_0D()
    ...
    QueueWorkItem(0x101, 2, lambda_B68)

    def lambda_B75():
        OP_93(0xFE, 0x87, 0x1F4)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_B75)

    def lambda_B82():
        OP_93(0xFE, 0xE1, 0x1F4)
        ExitThread()

    QueueWorkItem(0x103, 2, lambda_B82)

    def lambda_B8F():
        OP_93(0xFE, 0x13B, 0x1F4)
        ExitThread()

    QueueWorkItem(0x104, 2, lambda_B8F)
    WaitChrThread(0x8, 3)
    WaitChrThread(0x9, 3)
    WaitChrThread(0xA, 3)
    WaitChrThread(0xB, 3)
    ...
    QueueWorkItem(0xC, 1, lambda_C5A)
    Sound(812, 0, 100, 0)
    Sound(814, 0, 100, 0)
    WaitChrThread(0xC, 1)
    ...
    QueueWorkItem(0x8, 1, lambda_D53)

    def lambda_D67():
        OP_9A(0xFE, 0x102, 0x3E8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_D67)

    def lambda_D7B():
        OP_9A(0xFE, 0x103, 0x3E8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_D7B)

    def lambda_D8F():
        OP_9A(0xFE, 0x104, 0x3E8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_D8F)
    Sleep(50)
    ...
    QueueWorkItem(0xC, 1, lambda_DA6)
    Sleep(250)
    OP_24(0x361)
    ...
    def Function_7_EF7(): pass

    label("Function_7_EF7")
    ...
    QueueWorkItem(0x8, 1, lambda_F0A)
    WaitChrThread(0x8, 1)
    ...
    def Function_8_F57(): pass

    label("Function_8_F57")
    ...
    QueueWorkItem(0x9, 1, lambda_F6A)
    WaitChrThread(0x9, 1)
    ...
    def Function_9_FB7(): pass

    label("Function_9_FB7")
    ...
    QueueWorkItem(0xA, 1, lambda_FCA)
    WaitChrThread(0xA, 1)
    ...
    QueueWorkItem(0xA, 1, lambda_FE8)
    WaitChrThread(0xA, 1)
    ...
    def Function_10_1017(): pass

    label("Function_10_1017")
    ...
    QueueWorkItem(0xB, 1, lambda_102A)
    WaitChrThread(0xB, 1)
    ...
    QueueWorkItem(0xB, 1, lambda_1048)
    WaitChrThread(0xB, 1)
    ...
    # Function_10_1017 end

    def Function_11_1077(): pass

    label("Function_11_1077")
