...
def main():
    ...
    Sepith("Sepith_ED7", 0,   26,  8,   8,   0,   0,   8)
    Sepith("Sepith_ECF", 1,   19,  0,   26,  1,   0,   3)
    ...
    BattleInfo(
        "BattleInfo_2FC", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2050", "Sepith_ED7", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_3C4", 0x0000, 30, 6, 45, 4, 1, 30, 0, "bm2050", "Sepith_ECF", 40, 30, 20, 10,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_CE0")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x87, 1)"), scpexpr(EXPR_END)), "loc_C72")
    ...
    def Function_3_D29(): pass

    label("Function_3_D29")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11D, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E16")
    Sound(14, 0, 100, 0)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_DA8")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
