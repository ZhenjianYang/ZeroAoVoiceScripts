...
def main():
    ...
    Sepith("Sepith_A26", 0,   0,   14,  5,   3,   7,   6)
    Sepith("Sepith_A1E", 13,  0,   0,   6,   6,   5,   5)
    Sepith("Sepith_A2E", 0,   15,  0,   6,   4,   5,   5)
    ...
    BattleInfo(
        "BattleInfo_414", 0x0000, 21, 6, 60, 4, 1, 30, 0, "bm1020", "Sepith_A26", 40, 30, 20, 10,
        (
            ("ms64600.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms64600.dat", "ms64600.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms64600.dat", "ms62800.dat", "ms64600.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms64600.dat", "ms64600.dat", "ms62800.dat", "ms64600.dat", 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
        )
    )

    BattleInfo(
        "BattleInfo_284", 0x0000, 21, 6, 60, 4, 1, 25, 0, "bm1000", "Sepith_A1E", 40, 30, 20, 10,
        (
            ("ms63300.dat", "ms63300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms63300.dat", "ms64600.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms63300.dat", "ms64600.dat", "ms62800.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms63300.dat", "ms64600.dat", "ms62800.dat", "ms64600.dat", 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
        )
    )

    BattleInfo(
        "BattleInfo_34C", 0x0000, 21, 6, 60, 4, 1, 30, 0, "bm1020", "Sepith_A2E", 40, 30, 20, 10,
        (
            ("ms62800.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms62800.dat", "ms62800.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms62800.dat", "ms64600.dat", "ms62800.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_204", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
            ("ms62800.dat", "ms64600.dat", "ms62800.dat", "ms64600.dat", 0, 0, 0, 0, "MonsterBattlePostion_1E4", "MonsterBattlePostion_264", "ed7400", "ed7403", "ATBonus_1B4"),
        )
    )
    ...
    DeclMonster(3010,    -18420,  0,       0x1010000,    "BattleInfo_414", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(-5830,   160,     0,       0x1010000,    "BattleInfo_284", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-24680,  -7250,   0,       0x1010000,    "BattleInfo_34C", 0,   18,  0xFFFF, 2,  3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_76E")
    OP_70(0x0, 0x0)
    Jump("loc_772")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_785")
    OP_70(0x1, 0x0)
    Jump("loc_789")
    ...
    def Function_2_78A(): pass

    label("Function_2_78A")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_877")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x55, 1)"), scpexpr(EXPR_END)), "loc_809")
    ...
    def Function_3_8C0(): pass

    label("Function_3_8C0")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x11A, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9AD")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_93F")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
