...
def main():
    ...
    Sepith("Sepith_D32", 10,  0,   0,   4,   3,   5,   0)
    Sepith("Sepith_D3A", 4,   0,   1,   10,  5,   3,   0)
    Sepith("Sepith_D4A", 9,   0,   4,   0,   2,   0,   7)
    Sepith("Sepith_D42", 0,   10,  3,   0,   2,   0,   5)
    Sepith("Sepith_D7A", 14,  4,   9,   5,   7,   12,  9)
    ...
    BattleInfo(
        "BattleInfo_3C4", 0x0000, 14, 6, 45, 10, 1, 30, 0, "br2000", "Sepith_D32", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_554", 0x0000, 14, 6, 45, 10, 1, 40, 0, "br2000", "Sepith_D3A", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_61C", 0x0000, 14, 6, 45, 10, 1, 25, 0, "br2000", "Sepith_D4A", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_48C", 0x0000, 14, 6, 45, 10, 1, 25, 0, "br2000", "Sepith_D42", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_6E4", 0x0000, 35, 6, 45, 6, 1, 30, 0, "br2000", "Sepith_D7A", 40, 35, 25, 0,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x104, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BB8")
    Sound(14, 0, 100, 0)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x8E, 1)"), scpexpr(EXPR_END)), "loc_B4A")
    ...
    def Function_4_C15(): pass

    label("Function_4_C15")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_C41")
    ...
    def Function_6_C42(): pass

    label("Function_6_C42")
    ...
    OP_5A()
    OP_6F(0x1)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_D05")
    OP_E0(0x2)
