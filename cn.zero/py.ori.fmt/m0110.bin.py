...
def main():
    ...
    Sepith("Sepith_2AA4", 1,   8,   6,   1,   1,   1,   2)
    Sepith("Sepith_2AAC", 1,   8,   6,   1,   1,   1,   2)
    Sepith("Sepith_2AB4", 0,   1,   0,   2,   0,   0,   0)
    Sepith("Sepith_2ABC", 1,   1,   0,   1,   1,   0,   0)
    ...
    BattleInfo(
        "BattleInfo_578", 0x0000, 48, 6, 60, 6, 1, 25, 0, "bm0111", "Sepith_2AA4", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_960", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_2AAC", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_898", 0x0000, 48, 6, 60, 6, 1, 25, 0, "bm0110", "Sepith_2AA4", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_7D0", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_2AB4", 30, 45, 20, 5,
        (
    ...
    BattleInfo(
        "BattleInfo_A28", 0x0000, 48, 6, 60, 6, 1, 40, 0, "bm0110", "Sepith_2ABC", 30, 45, 20, 5,
        (
    ...
    ScpFunction((
        ...
        "Function_6_186E",         # 06, 6
        "Function_7_19A4",         # 07, 7
        "Function_8_1B07",         # 08, 8
        "Function_9_1CA9",         # 09, 9
        "Function_10_1E6C",        # 0A, 10
        "Function_11_205E",        # 0B, 11
        "Function_12_2221",        # 0C, 12
        "Function_13_2413",        # 0D, 13
        "Function_14_25F9",        # 0E, 14
        "Function_15_279B",        # 0F, 15
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_16EF")
    Sound(14, 0, 100, 0)
    OP_71(0x1B, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_1681")
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1825")
    Sound(14, 0, 100, 0)
    OP_71(0x1C, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_17B7")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_186E(): pass

    label("Function_6_186E")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_195B")
    Sound(14, 0, 100, 0)
    OP_71(0x1D, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x7E, 1)"), scpexpr(EXPR_END)), "loc_18ED")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_7_19A4(): pass

    label("Function_7_19A4")

    OP_F2(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x10E, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1AD8")
    Sound(14, 0, 100, 0)
    ...
    def Function_8_1B07(): pass

    label("Function_8_1B07")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1CA1")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 0)), scpexpr(EXPR_END)), "loc_1C4C")
    ...
    def Function_9_1CA9(): pass

    label("Function_9_1CA9")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1E64")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 1)), scpexpr(EXPR_END)), "loc_1DF4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 3)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1E3F")
    ClearScenarioFlags(0x0, 0)
    ...
    def Function_10_1E6C(): pass

    label("Function_10_1E6C")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2056")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_END)), "loc_1FD0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 3)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1F9E")
    ClearScenarioFlags(0x0, 0)
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2219")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 3)), scpexpr(EXPR_END)), "loc_21A9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 3)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_21F4")
    ClearScenarioFlags(0x0, 0)
    ...
    def Function_12_2221(): pass

    label("Function_12_2221")
    ...
    SetCameraDistance(38500, 0)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_END)), "loc_2385")
    SetMapObjFrame(0x12, "m01gim01", 0x2, "off")
    SetMapObjFrame(0x14, "m01gim01", 0x2, "off")
    Sound(138, 0, 100, 0)
    Sleep(1000)
    ...
    Sleep(1000)
    ClearScenarioFlags(0x55, 2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 3)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2353")
    ClearScenarioFlags(0x0, 0)
    ...
    # Function_12_2221 end

    def Function_13_2413(): pass

    label("Function_13_2413")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_25F1")
    Fade(500)
    ...
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 5)), scpexpr(EXPR_END)), "loc_2583")
    ...
    # Function_13_2413 end

    def Function_14_25F9(): pass

    label("Function_14_25F9")
    ...
    SetCameraDistance(37500, 0)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x55, 6)), scpexpr(EXPR_END)), "loc_273E")
    ...
    # Function_14_25F9 end

    def Function_15_279B(): pass

    label("Function_15_279B")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_290D")
    Fade(500)
    SetChrPos(0x0, 600, 0, -3400, 0)
    SetChrPos(0x1, -600, 0, -3400, 0)
    SetChrPos(0x2, -600, 0, -4600, 0)
    SetChrPos(0x3, 600, 0, -4600, 0)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_286D")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_288C")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xF), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_29E8")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xE), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2A07")
