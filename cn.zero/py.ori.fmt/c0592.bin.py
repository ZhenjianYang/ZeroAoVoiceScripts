...
def main():
    ...
    Sepith("Sepith_168F", 9,   9,   9,   9,   0,   19,  0)
    Sepith("Sepith_1687", 9,   9,   9,   9,   19,  0,   0)
    Sepith("Sepith_169F", 0,   0,   0,   0,   15,  20,  20)
    Sepith("Sepith_1697", 9,   9,   9,   9,   0,   0,   19)
    ...
    BattleInfo(
        "BattleInfo_478", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_168F", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_3B0", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_1687", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_608", 0x0000, 33, 6, 90, 0, 1, 0, 0, "bc0520", "Sepith_169F", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_540", 0x0000, 33, 6, 45, 4, 1, 30, 0, "bc0520", "Sepith_1697", 40, 30, 20, 10,
        (
    ...
    ScpFunction((
        ...
        "Function_8_126F",         # 08, 8
        "Function_9_1453",         # 09, 9
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x112, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EF6")
    Sound(14, 0, 100, 0)
    ...
    def Function_6_F3F(): pass

    label("Function_6_F3F")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x112, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_10FB")
    Sound(14, 0, 100, 0)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x76, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1038")
    ...
    QueueWorkItem(0x8, 1, lambda_F98)

    def lambda_FB2():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x3E8)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_FB2)
    ...
    OP_F2(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x112, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1226")
    Sound(14, 0, 100, 0)
    ...
    def Function_8_126F(): pass

    label("Function_8_126F")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 6)), scpexpr(EXPR_END)), "loc_12AC")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_144B")
    Fade(500)
    ...
    def Function_9_1453(): pass

    label("Function_9_1453")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD4, 7)), scpexpr(EXPR_END)), "loc_1490")
    TalkBegin(0xFF)
    SetChrName("")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_162F")
    Fade(500)
