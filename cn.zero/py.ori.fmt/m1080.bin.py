...
def main():
    ...
    Sepith("Sepith_6AD", 13,  0,   0,   6,   6,   5,   5)
    Sepith("Sepith_6D5", 6,   6,   6,   12,  2,   2,   2)
    ...
    BattleInfo(
        "BattleInfo_238", 0x0000, 21, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_6AD", 40, 30, 20, 10,
        (
            ("ms63300.dat", "ms63300.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1B8", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms63300.dat", "ms64600.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_198", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms63300.dat", "ms64600.dat", "ms62800.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_1B8", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms63300.dat", "ms64600.dat", "ms62800.dat", "ms64600.dat", 0, 0, 0, 0, "MonsterBattlePostion_198", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
        )
    )

    BattleInfo(
        "BattleInfo_300", 0x0000, 21, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_6D5", 40, 30, 20, 10,
        (
            ("ms75200.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1B8", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms75200.dat", "ms62700.dat", "ms62700.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_198", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms75200.dat", "ms62700.dat", "ms62700.dat", "ms62700.dat", 0, 0, 0, 0, "MonsterBattlePostion_1B8", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
            ("ms75200.dat", "ms62700.dat", "ms62700.dat", "ms62700.dat", "ms62700.dat", 0, 0, 0, "MonsterBattlePostion_198", "MonsterBattlePostion_218", "ed7400", "ed7403", "ATBonus_168"),
        )
    )
    ...
    def Function_2_592(): pass

    label("Function_2_592")
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_667")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x0, 0x1E)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_683")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
