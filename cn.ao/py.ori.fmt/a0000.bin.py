...
def main():
    ...
    MenuCmd(0, 0)
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('盾牌', 0x0)"), scpexpr(EXPR_END)), "loc_4ED2")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('法则', 0x0)"), scpexpr(EXPR_END)), "loc_4F1E")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('力量', 0x0)"), scpexpr(EXPR_END)), "loc_4F6A")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('妖精', 0x0)"), scpexpr(EXPR_END)), "loc_4FB6")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('力量', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_62F1")
    SubItemNumber('力量', 1)

    label("loc_62F1")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('盾牌', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6307")
    SubItemNumber('盾牌', 1)

    label("loc_6307")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('妖精', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_631D")
    SubItemNumber('妖精', 1)

    label("loc_631D")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('利爪', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6333")
    SubItemNumber('利爪', 1)

    label("loc_6333")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('白金', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6349")
    SubItemNumber('白金', 1)

    label("loc_6349")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('幻象', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_635F")
    SubItemNumber('幻象', 1)

    label("loc_635F")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('战斧', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6375")
    SubItemNumber('战斧', 1)

    label("loc_6375")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('法则', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_638B")
    SubItemNumber('法则', 1)

    label("loc_638B")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('羽翼', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_63A1")
    SubItemNumber('羽翼', 1)

    label("loc_63A1")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('神佑', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_63B7")
    SubItemNumber('神佑', 1)

    label("loc_63B7")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('王权', 0x0)"), scpexpr(EXPR_END)), "loc_63C7")
    SubItemNumber('王权', 1)

    label("loc_63C7")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('魅影', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_63DD")
    SubItemNumber('魅影', 1)

    label("loc_63DD")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('守护', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_63F3")
    SubItemNumber('守护', 1)

    label("loc_63F3")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('无限', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6409")
    SubItemNumber('无限', 1)

    label("loc_6409")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('小丑', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_641F")
    SubItemNumber('小丑', 1)

    label("loc_641F")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('罪恶', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6435")
    SubItemNumber('罪恶', 1)

    label("loc_6435")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('草⑿', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_644B")
    SubItemNumber('草⑿', 1)

    label("loc_644B")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('纹章', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6461")
    SubItemNumber('纹章', 1)

    label("loc_6461")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('灵猫', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_6477")
    SubItemNumber('灵猫', 1)

    label("loc_6477")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('骑士', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_648D")
    SubItemNumber('骑士', 1)

    label("loc_648D")

    Jc((scpexpr(EXPR_EXEC_OP, "GetItemNumber('贤者', 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_64A3")
    SubItemNumber('贤者', 1)
    ...
    AddItemNumber('翠耀神仙鱼', 1)
    OP_E4(0x2, 0x1A)
    Jump("loc_74BF")

    label("loc_7481")

    AddItemNumber('琥耀岩穴鱼', 1)
    OP_E4(0x2, 0x1B)
    Jump("loc_74BF")

    label("loc_748E")

    AddItemNumber('红耀食人鱼', 1)
    OP_E4(0x2, 0x1C)
    Jump("loc_74BF")

    label("loc_749B")

    AddItemNumber('苍耀巨龙鱼', 1)
    OP_E4(0x2, 0x1D)
    Jump("loc_74BF")

    label("loc_74A8")

    AddItemNumber('巨骨龙皇鱼', 1)
    OP_E4(0x2, 0x1E)
    Jump("loc_74BF")
