...
def main():
    ...
    ATBonus("ATBonus_494", 100, 5, 1, 5, 1, 5, 1, 5, 5, 5, 5, 5, 5, 0, 0, 0)
    ATBonus("ATBonus_484", 100, 5, 1, 5, 1, 5, 1, 5, 5, 0, 0, 0, 1, 0, 0, 0)
    ATBonus("ATBonus_4A4", 100, 5, 0, 5, 0, 5, 0, 2, 5, 0, 0, 0, 2, 0, 0, 0)

    Sepith("Sepith_1F3D", 9,   9,   9,   9,   10,  10,  10)
    Sepith("Sepith_1F25", 7,   7,   7,   7,   11,  11,  11)
    Sepith("Sepith_1F35", 0,   0,   0,   0,   15,  38,  15)
    Sepith("Sepith_1F45", 11,  23,  0,   15,  0,   0,   19)
    Sepith("Sepith_1F2D", 9,   2,   15,  8,   11,  18,  1)
    Sepith("Sepith_1F1D", 13,  13,  13,  13,  4,   4,   4)

    MonsterBattlePostion("MonsterBattlePostion_4E4", 8, 8, 180)
    MonsterBattlePostion("MonsterBattlePostion_4E8", 5, 9, 180)
    MonsterBattlePostion("MonsterBattlePostion_4EC", 11, 10, 180)
    MonsterBattlePostion("MonsterBattlePostion_4F0", 6, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_4F4", 10, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_4F8", 13, 13, 180)
    MonsterBattlePostion("MonsterBattlePostion_4FC", 4, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_500", 8, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_544", 7, 4, 0)
    MonsterBattlePostion("MonsterBattlePostion_548", 10, 11, 225)
    MonsterBattlePostion("MonsterBattlePostion_54C", 4, 7, 90)
    MonsterBattlePostion("MonsterBattlePostion_550", 12, 7, 270)
    MonsterBattlePostion("MonsterBattlePostion_554", 4, 11, 135)
    MonsterBattlePostion("MonsterBattlePostion_558", 11, 4, 315)
    MonsterBattlePostion("MonsterBattlePostion_55C", 7, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_560", 5, 5, 45)
    MonsterBattlePostion("MonsterBattlePostion_4C4", 7, 9, 180)
    MonsterBattlePostion("MonsterBattlePostion_4C8", 11, 10, 180)
    MonsterBattlePostion("MonsterBattlePostion_4CC", 10, 13, 180)
    MonsterBattlePostion("MonsterBattlePostion_4D0", 5, 11, 180)
    MonsterBattlePostion("MonsterBattlePostion_4D4", 12, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_4D8", 4, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_4DC", 14, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_4E0", 2, 13, 180)

    # monster count: 21

    BattleInfo(
        "BattleInfo_82C", 0x0000, 100, 6, 60, 4, 1, 30, 0, "bm9020", "Sepith_1F3D", 40, 30, 20, 10,
        (
            ("ms79900.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms79900.dat", "ms79900.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms79900.dat", "ms79900.dat", "ms79900.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms79900.dat", "ms79900.dat", "ms79900.dat", "ms79900.dat", 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
        )
    )

    BattleInfo(
        "BattleInfo_600", 0x0000, 100, 6, 60, 10, 1, 40, 0, "bm9020", "Sepith_1F25", 40, 30, 20, 10,
        (
            ("ms80900.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_484"),
            ("ms80900.dat", "ms80900.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_484"),
            ("ms80900.dat", "ms80900.dat", "ms80900.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_484"),
            ("ms80900.dat", "ms80900.dat", "ms80900.dat", "ms80900.dat", 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_484"),
        )
    )

    BattleInfo(
        "BattleInfo_790", 0x0010, 100, 6, 180, 10, 1, 5, 0, "bm9020", "Sepith_1F35", 50, 35, 15, 0,
        (
            ("ms74200.dat", 0, 0, 0, 0, 0, "ms85200.dat", 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms74200.dat", "ms74200.dat", 0, 0, 0, 0, "ms85200.dat", 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms74200.dat", "ms74200.dat", "ms74200.dat", 0, 0, 0, "ms85200.dat", 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            (),
        )
    )

    BattleInfo(
        "BattleInfo_8F4", 0x0000, 100, 6, 60, 4, 1, 30, 0, "bm9020", "Sepith_1F45", 100, 0, 0, 0,
        (
            ("ms85200.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            (),
            (),
            (),
        )
    ...
    BattleInfo(
        "BattleInfo_6C8", 0x0000, 100, 6, 60, 10, 1, 30, 0, "bm9020", "Sepith_1F2D", 40, 30, 20, 10,
        (
            ("ms85000.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms85000.dat", "ms85000.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms85000.dat", "ms85000.dat", "ms85000.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms85000.dat", "ms85000.dat", "ms85000.dat", "ms85000.dat", 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
        )
    )

    BattleInfo(
        "BattleInfo_564", 0x0000, 100, 6, 60, 10, 1, 35, 0, "bm9020", "Sepith_1F1D", 50, 30, 20, 0,
        (
            ("ms85300.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms85300.dat", "ms80900.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            ("ms85300.dat", "ms80900.dat", "ms80900.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_4E4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_494"),
            (),
        )
    )
    ...
    BattleInfo(
        "BattleInfo_938", 0x0C00, 255, 6, 0, 0, 3, 0, 0, "bm9020", 0x00000000, 100, 0, 0, 0,
        (
            ("ms85200.dat", "ms85200.dat", "ms85200.dat", "ms85200.dat", "ms85200.dat", "ms85200.dat", "ms85200.dat", "ms85200.dat", "MonsterBattlePostion_4C4", "MonsterBattlePostion_544", "ed7452", "ed7453", "ATBonus_4A4"),
            (),
            (),
            (),
        )
    ...
    DeclNpc(97750,   57500,   18250,   0,    484,  0x0, 0,   26,  0,   0,   0,   255, 255, 255,  0)

    DeclMonster(-42680,  -96420,  -20000,  0x1010125,    "BattleInfo_82C", 0,   24,  0xFFFF, 8,  9)
    DeclMonster(-4960,   -102310, -20000,  0x1010110,    "BattleInfo_600", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(-17170,  -111500, -23000,  0x1010062,    "BattleInfo_790", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(18200,   -89750,  -20250,  0x10100A8,    "BattleInfo_8F4", 0,   26,  0xFFFF, 10, 11)
    DeclMonster(18560,   -102290, -20250,  0x101015D,    "BattleInfo_8F4", 0,   26,  0xFFFF, 10, 11)
    DeclMonster(57710,   -92810,  -20000,  0x1010148,    "BattleInfo_6C8", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(97410,   -61530,  20000,   0x1010037,    "BattleInfo_790", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(89300,   -82650,  17000,   0x1010084,    "BattleInfo_600", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(97060,   -86420,  17000,   0x1010137,    "BattleInfo_600", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(122840,  -47270,  20000,   0x1010123,    "BattleInfo_82C", 0,   24,  0xFFFF, 8,  9)
    DeclMonster(121990,  -19650,  16750,   0x101004F,    "BattleInfo_8F4", 0,   26,  0xFFFF, 10, 11)
    DeclMonster(137970,  -19480,  16750,   0x1010116,    "BattleInfo_6C8", 0,   20,  0xFFFF, 4,  5)
    DeclMonster(122570,  23900,   20000,   0x10100A8,    "BattleInfo_564", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(114420,  -7250,   23000,   0x1010004,    "BattleInfo_82C", 0,   24,  0xFFFF, 8,  9)
    DeclMonster(95230,   -28750,  60000,   0x101011E,    "BattleInfo_82C", 0,   24,  0xFFFF, 8,  9)
    DeclMonster(101530,  -55780,  57000,   0x101001C,    "BattleInfo_8F4", 0,   26,  0xFFFF, 10, 11)
    DeclMonster(92020,   360,     57000,   0x10100B3,    "BattleInfo_600", 0,   18,  0xFFFF, 2,  3)
    DeclMonster(79560,   -55300,  60000,   0x1010023,    "BattleInfo_790", 0,   22,  0xFFFF, 6,  7)
    DeclMonster(62480,   -69650,  59750,   0x101003F,    "BattleInfo_564", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(75460,   -75580,  59750,   0x101013B,    "BattleInfo_564", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(49220,   -95160,  60000,   0x1010017,    "BattleInfo_82C", 0,   24,  0xFFFF, 8,  9)

    DeclActor(89000,   17000,   -90500,  1200,    89000,   18000,   -90500,  0x007C, 0,  3,  0x0000)
    DeclActor(109250,  23000,   -7250,   1200,    109250,  24000,   -7250,   0x007C, 0,  4,  0x0000)
    DeclActor(97750,   57000,   18250,   1200,    97750,   58000,   18250,   0x007C, 0,  5,  0x0000)
    DeclActor(86000,   57000,   -64000,  1200,    86000,   58000,   -64000,  0x007C, 0,  6,  0x0000)
    DeclActor(-20750,  -23000,  -110250, 1200,    -20750,  -22000,  -110250, 0x007C, 0,  7,  0x0000)
    ...
    ScpFunction((
        ...
        "Function_1_A4B",          # 01, 1
        "Function_2_A4C",          # 02, 2
        "Function_3_1853",         # 03, 3
        "Function_4_1946",         # 04, 4
        "Function_5_1A81",         # 05, 5
        "Function_6_1C7F",         # 06, 6
        "Function_7_1DBA",         # 07, 7
    ))
    ...
    def Function_2_A4C(): pass

    label("Function_2_A4C")
    ...
    OP_52(0xF, 0x14, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0xD, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x15, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0xE, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x16, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0xF, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x17, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x10, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x18, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x11, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x19, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x12, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x1A, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x13, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0xF, 0x1B, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0xC, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x14, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0xD, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x15, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0xE, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x16, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0xF, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x17, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x10, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x18, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x11, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x19, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x12, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x1A, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x13, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x1A, 0x1B, (scpexpr(EXPR_PUSH_LONG, 0xFB), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    OP_52(0x13, 0x14, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0xD, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x15, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0xE, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x16, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0xF, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x17, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x10, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x18, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x11, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x19, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x12, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x1A, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x13, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x13, 0x1B, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    OP_52(0x8, 0x14, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0xD, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x15, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0xE, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x16, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0xF, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x17, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x10, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x18, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x11, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x19, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x12, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x1A, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x13, (scpexpr(EXPR_PUSH_LONG, 0x80), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_52(0x8, 0x1B, (scpexpr(EXPR_PUSH_LONG, 0xC7), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x200, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_17EC")
    OP_70(0x0, 0x0)
    Jump("loc_17F0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x200, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1803")
    OP_70(0x1, 0x0)
    Jump("loc_1807")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_181A")
    OP_70(0x2, 0x0)
    Jump("loc_181E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1831")
    OP_70(0x3, 0x0)
    Jump("loc_1835")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1848")
    OP_70(0x4, 0x0)
    Jump("loc_184C")
    ...
    def Function_3_1853(): pass

    label("Function_3_1853")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x200, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1917")
    Sound(14, 0, 100, 0)
    OP_74(0x0, 0x1E)
    ...
    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x200, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1A38")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1F7, 1)"), scpexpr(EXPR_END)), "loc_19C9")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_5_1A81(): pass

    label("Function_5_1A81")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1C41")
    Sound(14, 0, 100, 0)
    OP_74(0x2, 0x1E)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x207, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B7E")
    ...
    QueueWorkItem(0x8, 1, lambda_1ADE)

    def lambda_1AF8():
        OP_A7(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x3E8)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_1AF8)
    ...
    OP_57(0x0)
    WaitChrThread(0x8, 1)
    Battle("BattleInfo_938", 0x0, 0x0, 0x0, 0xB, 0xFF)
    ...
    Switch(
        ...
        (2, "loc_1B6E"),
        (1, "loc_1B7B"),
        (SWITCH_DEFAULT, "loc_1B7E"),
    )


    label("loc_1B5F")

    SetScenarioFlags(0x207, 4)
    OP_70(0x2, 0x1E)
    Sleep(500)
    Jump("loc_1B7E")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x458, 1)"), scpexpr(EXPR_END)), "loc_1BD5")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_6_1C7F(): pass

    label("Function_6_1C7F")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1D71")
    Sound(14, 0, 100, 0)
    OP_74(0x3, 0x1E)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FA, 1)"), scpexpr(EXPR_END)), "loc_1D02")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_7_1DBA(): pass

    label("Function_7_1DBA")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x201, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1EAC")
    Sound(14, 0, 100, 0)
    OP_74(0x4, 0x1E)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FA, 1)"), scpexpr(EXPR_END)), "loc_1E3D")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
