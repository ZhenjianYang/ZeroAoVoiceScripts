...
def main():
    ...
    Sepith("Sepith_E3D", 2,   3,   4,   3,   2,   0,   2)
    Sepith("Sepith_E45", 3,   0,   4,   2,   3,   4,   0)
    Sepith("Sepith_E35", 2,   7,   2,   2,   0,   3,   0)
    ...
    BattleInfo(
        "BattleInfo_4A4", 0x0010, 54, 6, 45, 10, 1, 40, 0, "bm4110", "Sepith_E3D", 40, 30, 20, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_540", 0x0000, 54, 6, 45, 10, 1, 20, 0, "bm4110", "Sepith_E45", 40, 30, 20, 0,
        (
    ...
    BattleInfo(
        "BattleInfo_408", 0x0000, 54, 6, 45, 10, 1, 30, 0, "bm4110", "Sepith_E35", 40, 30, 20, 0,
        (
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B30")
    Sound(14, 0, 100, 0)
    OP_74(0x0, 0x1E)
    OP_71(0x0, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x5E0, 1)"), scpexpr(EXPR_END)), "loc_AC1")
    ...
    def Function_3_B79(): pass

    label("Function_3_B79")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C6B")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x45, 1)"), scpexpr(EXPR_END)), "loc_BFC")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_4_CB4(): pass

    label("Function_4_CB4")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    FadeToDark(300, 0, 100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1FA, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DDE")
    Sound(14, 0, 100, 0)
    OP_74(0x2, 0x1E)
