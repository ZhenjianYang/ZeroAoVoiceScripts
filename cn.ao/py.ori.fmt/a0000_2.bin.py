...
def main():
    CreateScenaFile(
        ...
        # Information
        [300, 712, 1078, 1465, 2641, 3725, 4926, 5298, 6379, 0, 7539, 0, 8746, 9068, 10190, 10769, 0, 11799, 0, 196, 50, 0, 0],
    )
    ...
    Menu(
        ...
        (
            "▼絆イベント\x01",                        # 0
            "▼6107オルキスタワー屋上の回想\x01",      # 1
            "▼クロスベルタイムズ用シーン１\x01",      # 2
            "▼クロスベルタイムズ用シーン２\x01",      # 3
            "▼クロスベルタイムズ用シーン３\x01",      # 4
            "▼クロスベルタイムズ用シーン４\x01",      # 5
            "キャンセル\x01",                          # 6
        )
    )
    ...
    Menu(
        ...
        1,
        (
            "①▼0001Ｄ∴Ｇ教団アルタイルロ\x01",      # 0
            "②▼0003Ｄ∴Ｇ教団アルタイルロ\x01",      # 1
            "③▼0008アリオスたちの強さに感\x01",      # 2
            "④▼0010アーネストとハルトマン\x01",      # 3
            "⑤▼0011アーネストとハルトマン\x01",      # 4
            "⑥▼0012ノエル＆特務支援課につ\x01",      # 5
            "⑦▼0014キーアやフランについて\x01",      # 6
            "⑧▼0015Ｄ∴Ｇ教団についての話\x01",      # 7
            "⑨▼0017アーネストの元に辿り着\x01",      # 8
            "⑩▼0018魔人アーネスト戦闘後\x01",        # 9
            "?▼0019真魔人アーネスト戦闘後\x01",       # 10
            "?▼0020ダドリーたちと別れる\x01",         # 11
            "?▼0021大陸横断鉄道（タングラ\x01",       # 12
            "?▼0023大陸横断鉄道（東クロス\x01",       # 13
            "?▼0025クロスベル駅に到着\x01",           # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        1,
        (
            "①▼1001支援要請についてのチュ\x01",      # 0
            "②▼1006部屋でキーアと合流する\x01",      # 1
            "③▼1007裏口の工事状況を確認す\x01",      # 2
            "④▼1008キーアたちが去っていく\x01",      # 3
            "⑤▼1009セルゲイからの連絡を受\x01",      # 4
            "⑥▼1011西クロスベル街道に出た\x01",      # 5
            "⑦▼1012隻眼の中年男と遭遇する\x01",      # 6
            "⑧▼1015警察学校の入口を確認す\x01",      # 7
            "⑨▼1016ノックス森林道に足を踏\x01",      # 8
            "⑩▼1018警察学校の玄関前に到着\x01",      # 9
            "?▼1020警察学校の中に入る\x01",           # 10
            "?▼1021新型導力車を受け取る\x01",         # 11
            "?▼1025新型導力車に乗り込む（\x01",       # 12
            "?▼1030夕暮れのクロスベルに到\x01",       # 13
            "?▼1032キーアを迎えに行く（中\x01",       # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            "①▼1037年長クラスの授業\x01",            # 0
            "②▼1038導力車をキーアにお披露\x01",      # 1
            "③▼1043ティオからの連絡\x01",            # 2
            "④▼1044雨のクロスベル\x01",              # 3
            "⑤▼1048交換屋ナインヴァリを訪\x01",      # 4
            "⑥▼1052ヴァルド登場\x01",                # 5
            "⑦▼1053ヴァルド登場（戦闘後）\x01",      # 6
            "⑧▼1055フランからの連絡\x01",            # 7
            "⑨▽1071ローゼンベルク工房を訪\x01",      # 8
            "⑩▼1075ビクセン町長からの依頼\x01",      # 9
            "?▼1076旧鉱山前にやって来る\x01",         # 10
            "?▼1081旧鉱山前の２マップ目に\x01",       # 11
            "?▼1082巨大な幻獣が出現\x01",             # 12
            "?▼1083巨大な幻獣が出現（戦闘\x01",       # 13
            "?▼1084マインツを後にする\x01",           # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        1,
        (
            "①▼2001お披露目前のオルキスタ\x01",      # 0
            "②▼2002警備対策会議に同席\x01",          # 1
            "③▼2003市内に配置される警官た\x01",      # 2
            "④▼2005ランディとのやり取り（\x01",      # 3
            "⑤▼2007ミシェルからの連絡（タ\x01",      # 4
            "⑥▼2008ミシェルからの連絡（病\x01",      # 5
            "⑦▼2009ギルドでミシェルと話す\x01",      # 6
            "⑧▼2011支援課に帰る（東通り）\x01",      # 7
            "⑨▼2014ノイエ＝ブランへ向かう\x01",      # 8
            "⑩▼2017ノイエ＝ブランに到着\x01",        # 9
            "?▼2020首脳来訪前夜（執務室）\x01",       # 10
            "?▼2021首脳来訪前夜（アルセイ\x01",       # 11
            "?▼2022首脳来訪前夜（ヨナ端末\x01",       # 12
    ...
    Menu(
        ...
        (
            ...
            "③▼2034リムジンで移動（中央）\x01",      # 2
            "④▼2036オルキスタワーのお披露\x01",      # 3
            "⑤▼2041２日目午後?中央広場の\x01",       # 4
            "⑥▼2044キークエスト終了\x01",            # 5
            "⑦▼2045支援課での休憩\x01",              # 6
            "⑧▼2048空港前選択肢\x01",                # 7
            "⑨▼2053夜の中央広場\x01",                # 8
            "⑩▼2055ジオフロントＢ区画の扉\x01",      # 9
            "?▼2057中ボス戦\x01",                     # 10
            "?▼2058ヨナの部屋の前に到着す\x01",       # 11
            "?▼2062３日目開始\x01",                   # 12
            "?▼2064オルキスタワー前にやっ\x01",       # 13
            "?▼2067ディーター市長のタワー\x01",       # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "③▼2086ロックスミス大統領との\x01",      # 2
            "④▼2087オズボーンの部屋を確認\x01",      # 3
            "⑤▼2089通商会議後半開始\x01",            # 4
            "⑥▼2093飛行艇の襲撃\x01",                # 5
            "⑦▼2098非常階段の封鎖を確認\x01",        # 6
            "⑧▼2100タワーの制御を解放\x01",          # 7
            "⑨▼2101降下してゆくエレベータ\x01",      # 8
            "⑩▼2104アリオスたちと２手に分\x01",      # 9
            "?▼2105地下駐車場に入る\x01",             # 10
            "?▼2107貨物路線場の手前で爆発\x01",       # 11
            "?▼2111テロリストたちに追いつ\x01",       # 12
    ...
    Menu(
        ...
        1,
        (
            "①▼I001エルム湖上?水上バス\x01",         # 0
            "②▼I005キーアが甲板に現れる\x01",        # 1
            "③▼I007ミシュラムに到着\x01",            # 2
            "④▼I008ホテルの部屋を案内\x01",          # 3
            "⑤▼I011湖水浴場の受付前に来る\x01",      # 4
            "⑥▼I013女性陣登場\x01",                  # 5
            "⑦▼I014スイカ割り\x01",                  # 6
            "⑧▼I016キーアを探しに行くこと\x01",      # 7
            "⑨▼I017キーアを発見\x01",                # 8
            "⑩▼I018テーマパーク前で合流\x01",        # 9
            "?▼I020テーマパークを後にする\x01",       # 10
            "?▼I021夜のホテル\x01",                   # 11
            "?▼I023キーアに関しての確認\x01",         # 12
            "?▼I024迎賓館に到着\x01",                 # 13
    ...
    Menu(
        ...
        (
            "①▼I029ロイドの悪夢\x01",                # 0
            "②▼I033装飾が変わった夜のテー\x01",      # 1
            "③▼I034装飾が変わったテーマパ\x01",      # 2
            "④▼I035カンパネルラ登場\x01",            # 3
            "⑤▼I036鏡の城の手前でキーアを\x01",      # 4
            "⑥▼I037ミシュラムを後にする（\x01",      # 5
            "キャンセル\x01",                          # 6
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "⑤▼3008ウルスラ間道?幻獣を発\x01",       # 4
            "⑥▼3009ウルスラ間道?幻獣を退\x01",       # 5
            "⑦▼3012東クロスベル街道?幻獣\x01",       # 6
            "⑧▼3013東クロスベル街道?幻獣\x01",       # 7
            "⑨▼3016イアン弁護士と遭遇\x01",          # 8
            "⑩▼3017大司教から声をかけられ\x01",      # 9
            "?▼3019リースからプレロマ草の\x01",       # 10
            "?▼3021闇の中での会話\x01",               # 11
            "?▼3022朝の中央広場\x01",                 # 12
            "?▼3025人形工房前でのやり取り\x01",       # 13
            "?▼3028ヨルグ老人からの情報\x01",         # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "⑦▼3048魔人ヴァルド襲来\x01",            # 6
            "⑧▼3049魔人ヴァルド襲来（戦闘\x01",      # 7
            "⑨▼3050雨の旧市街\x01",                  # 8
            "⑩▼3052ミシェルとの会話\x01",            # 9
            "?▼3053ＩＢＣで主任を呼び出す\x01",       # 10
            "?▼3054オルキスタワーを訪れる\x01",       # 11
            "?▼3058オルキスタワーの屋上に\x01",       # 12
            "?▼3061波止場でボートに乗り込\x01",       # 13
            "?▼3065エルム湖上でのやり取り\x01",       # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "⑥▼3071湿地帯からの帰り\x01",            # 5
            "⑦▼3073裏通りのビルに到着する\x01",      # 6
            "⑧▼3075マインツ山道での交戦\x01",        # 7
            "⑨▼3078マインツ山道での交戦（\x01",      # 8
            "⑩▼3081夜のオルキスタワー外観\x01",      # 9
            "?▼3083宵の口の中央広場\x01",             # 10
            "?▼3085深夜の中央広場\x01",               # 11
            "?▼3088ランディの失踪\x01",               # 12
            "?▼3096デパート屋上でのツァオ\x01",       # 13
            "?▼3101ザイルを確認\x01",                 # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            "①▼4001夕方の歓楽街\x01",                # 0
            "②▼4003火の手が上がった歓楽街\x01",      # 1
            "③▼4006オルキスタワー前の攻防\x01",      # 2
            "④▼4007旧市街の魔人ヴァルド\x01",        # 3
            "⑤▼4008黒月襲撃\x01",                    # 4
            "⑥▼4010戻ってきたロイドたち\x01",        # 5
            "⑦▼4013ＩＢＣから逃げてきた人\x01",      # 6
            "⑧▼4016戦鬼シグムントとの戦い\x01",      # 7
            "⑨▼4017戦鬼シグムントとの戦い\x01",      # 8
            "⑩▼4020デパート屋上でのやり取\x01",      # 9
            "?▼4023１週間後のクロスベル（\x01",       # 10
            "?▼4027支援業務再開\x01",                 # 11
            "?▼4030ウルスラ病院に入る\x01",           # 12
            "?▼4032フランのお見舞い\x01",             # 13
            "?▼4035ヨナからの連絡\x01",               # 14
            "キャンセル\x01",                          # 15
        )
    ...
    Menu(
        ...
        1,
        (
            "①▼4036港湾区の灯台前のヨナ\x01",        # 0
            "②▼4037熱処理プラントの空間に\x01",      # 1
            "③▼4038中間地点までやって来る\x01",      # 2
            "④▼4039トルゾーＺとの戦い\x01",          # 3
            "⑤▼4040トルゾーＺとの戦い（戦\x01",      # 4
            "⑥▼4042灯台から外に出てくる\x01",        # 5
            "⑦▼4044セシルの訪問\x01",                # 6
            "⑧▼4045大統領就任演説１\x01",            # 7
            "⑨▼4053大統領就任演説10\x01",            # 8
            "⑩▼4054ギルドでの会話\x01",              # 9
            "?▼4055旧ルバーチェ商会前に来\x01",       # 10
            "?▼4057会長室に入る\x01",                 # 11
            "?▼4059連れ去られたキーア\x01",           # 12
            "?▼4061ミシュラムに到着\x01",             # 13
            "?▼4062テーマパーク前の幻獣戦\x01",       # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "⑥▼4072帝国軍侵攻\x01",                  # 5
            "⑦▼4074キーア覚醒?前\x01",               # 6
            "⑧▼4084アリオス国防長官との戦\x01",      # 7
            "⑨▼4085キーア覚醒?後\x01",               # 8
            "⑩▼4086神機アイオーン降臨\x01",          # 9
            "?▼4095共和国軍壊滅?空\x01",              # 10
            "?▼4088帝国軍壊滅\x01",                   # 11
            "?▼4089ガレリア要塞\x01",                 # 12
            "?▼4091オルキスタワー屋上\x01",           # 13
            "?▼4092ロイド拘束\x01",                   # 14
            "キャンセル\x01",                          # 15
        )
    )
    ...
    Menu(
        ...
        (
            "①▼5001ベイオウルフ号甲板\x01",          # 0
            "②▼5002ヴァルドが旧市街に現れ\x01",      # 1
            "③▼5003タワー屋上?結社の会話\x01",       # 2
            "④▼5005脱走開始\x01",                    # 3
            "⑤▼5006国防軍兵士との戦闘①\x01",        # 4
            "⑥▼5008国防軍兵士との戦闘②\x01",        # 5
            "⑦▼5010国防軍兵士との戦闘③\x01",        # 6
    ...
    Menu(
        ...
        1,
        (
            "①▼6001飛行する２機のメルカバ\x01",      # 0
            "②▼6003クロスベル領空潜入\x01",          # 1
            "③▼6004玖号機のキャビン\x01",            # 2
            "④▼6008中州の外れに降り立つ\x01",        # 3
            "⑤▼6009ウルスラ間道途中の幻獣\x01",      # 4
            "⑥▼6011ウルスラ病院前の様子を\x01",      # 5
            "⑦▼6014突入前選択肢\x01",                # 6
            "⑧▼6016病院前での国防軍との戦\x01",      # 7
            "⑨▼6018イリアを見舞うイベント\x01",      # 8
            "⑩▼6020ドノバンを見舞うイベン\x01",      # 9
            "?▼6022ウルスラ病院を後にする\x01",       # 10
            "?▼6024飛行するメルカバ\x01",             # 11
            "?▼6027アルモリカ村に到着する\x01",       # 12
            "?▼6029ハロルド一家と会う\x01",           # 13
            "キャンセル\x01",                          # 14
        )
    )
    ...
    Menu(
        ...
        (
            "①▼6031古戦場に到着する\x01",            # 0
            "②▼6032《赤い星座》の待ち伏せ\x01",      # 1
            "③▼6033リーシャ＆黒月登場\x01",          # 2
            "④▼6035飛行するメルカバ２\x01",          # 3
            "⑤▼6037マインツ山道に到着する\x01",      # 4
            "⑥▼6038工房前に到着する\x01",            # 5
            ...
            "?▼6048マインツ?宿酒場\x01",              # 11
            "?▼6050飛行するメルカバ３\x01",           # 12
            "?▼6052西クロスベル街道に到着\x01",       # 13
            "キャンセル\x01",                          # 14
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "②▼6058ベルガード門に到着する\x01",      # 1
            "③▼6060立ち塞がるノエル\x01",            # 2
            "④▼6061ソーニャ司令登場\x01",            # 3
            "⑤▼6064飛行するメルカバ４\x01",          # 4
            "⑥▼6067ミシュラムの攻略を開始\x01",      # 5
            "⑦▼6069ビーチマップから出る直\x01",      # 6
            "⑧▼6071ツァイトの陽動\x01",              # 7
            "⑨▼6073アーケードでの戦闘\x01",          # 8
            "⑩▼6074別荘区画での戦闘\x01",            # 9
            "?▼6075迎賓館前での戦闘\x01",             # 10
    ...
    Menu(
        ...
        (
            "①▼6079飛行するメルカバ５\x01",          # 0
            "②▼6083無線ブースター地点上空\x01",      # 1
            "③▼6084クロスベル独立国の無効\x01",      # 2
            "④▼6092ヨルグからの連絡\x01",            # 3
            "⑤▼6093月の僧院前にやって来る\x01",      # 4
            "⑥▼6095封印された扉を確認する\x01",      # 5
            "⑦▼6096道化師カンパネルラとの\x01",      # 6
            "⑧▼6097道化師カンパネルラとの\x01",      # 7
    ...
    Menu(
        ...
        1,
        (
            "①▼6109クロスベル市の結界が解\x01",      # 0
            "②▼6117夜のメルカバ\x01",                # 1
            "③▼6118メルカバ合流\x01",                # 2
            "④▼6119クロスベル市解放作戦開\x01",      # 3
            "⑤▼6120クロスベル市解放作戦開\x01",      # 4
            "⑥▼6121メルカバ伍号機がアイオ\x01",      # 5
            "⑦▼6125クロスベル市解放作戦開\x01",      # 6
            "⑧▼6127クロスベル市解放作戦開\x01",      # 7
            "⑨▼6129襲い掛かる魔導兵\x01",            # 8
            "⑩▼6131課長たちと打ち合わせ\x01",        # 9
            "?▽6132支援課に戻ってくる\x01",           # 10
            "?▼6133導力車をチェック\x01",             # 11
            "?▼6134クロスベル駅前選択肢\x01",         # 12
    ...
    Menu(
        ...
        1,
        (
            "①▼6139オルキスタワー突入作戦\x01",      # 0
            "②▼6141メルカバ伍号機ＶＳ高速\x01",      # 1
            "③▼6144パテル＝マテルＶＳ重量\x01",      # 2
            "④▼6145攻略を開始するロイドた\x01",      # 3
            "⑤▼6147中枢区画に入る\x01",              # 4
            "⑥▼6150制御ターミナル室に入る\x01",      # 5
            "⑦▼6151３６Ｆに到着する\x01",            # 6
            "⑧▼6152シズクとの再会\x01",              # 7
            "⑨▼6153エレベーターで４０Ｆへ\x01",      # 8
            "⑩▼6157ディーターとの対峙\x01",          # 9
            "?▼6158ディーターとの対峙（戦\x01",       # 10
            "?▼6161《碧の大樹》が出現する\x01",       # 11
            "?▼6162飛行するメルカバ６\x01",           # 12
            "?▼6165メルカバＶＳベイオウル\x01",       # 13
            "キャンセル\x01",                          # 14
        )
    )
    ...
    Menu(
        ...
        (
            ...
            "②▼6173中間地点に到達する\x01",          # 1
            "③▼6176象の領域に入る\x01",              # 2
            "④▼6177ヴァルドとの最終決戦\x01",        # 3
            "⑤▼6178ヴァルドとの最終決戦（\x01",      # 4
            "⑥▼6183色の領域に入る\x01",              # 5
            "⑦▼6186シャーリィとの最終決戦\x01",      # 6
            "⑧▼6187シャーリィとの最終決戦\x01",      # 7
            "⑨▼6191シャーリィの独り言\x01",          # 8
            "⑩▼6193業の領域への入口を発見\x01",      # 9
            "?▼6194業の領域に入る\x01",               # 10
            "?▼6195シグムントとの最終決戦\x01",       # 11
            "?▼6196シグムントとの最終決戦\x01",       # 12
    ...
    Menu(
        ...
        (
            "①▼6201戒の領域に入る\x01",              # 0
            "②▼6202アリオスとの最終決戦\x01",        # 1
            "③▼6203アリオスとの最終決戦（\x01",      # 2
            "④▼6207昇降機前選択肢\x01",              # 3
            "⑤▼6210マリアベルとの戦い\x01",          # 4
    ...
    Menu(
        ...
        (
            ...
            "QS_1307 テーマパークのアルバイト\x01",      # 6
            "QS_1308 不審商人の調査\x01",                # 7
            "QS_1309 西クロスベル街道の手配魔\x01",      # 8
            "QS_1310 クロスベル問題の取材協力\x01",      # 9
            "QS_1311 市民フォーラムへの参加要\x01",      # 10
            "QS_1312 暴走車の追跡\x01",                  # 11
            "QS_1313 ジオフロントＤ１区画の手\x01",      # 12
    ...
    Menu(
        ...
        (
            ...
            "QS_1402 チャリティイベントへの協\x01",      # 1
            "QS_1403 生き別れの父の捜索\x01",            # 2
            "QS_1404 古戦場の調査\x01",                  # 3
            "QS_1405 ノックス森林道の手配魔獣\x01",      # 4
            "QS_1406 医療物資の捜索\x01",                # 5
            "QS_1407 ジオフロントＣ区画の手配\x01",      # 6
