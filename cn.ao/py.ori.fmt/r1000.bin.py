...
def main():
    ...
    Sepith("Sepith_3F3A", 4,   2,   3,   0,   3,   0,   0)
    Sepith("Sepith_3F42", 2,   0,   3,   4,   0,   0,   3)
    Sepith("Sepith_3F82", 2,   1,   4,   1,   0,   2,   2)
    Sepith("Sepith_3F7A", 5,   5,   0,   3,   0,   0,   0)
    Sepith("Sepith_3F92", 11,  7,   4,   3,   6,   12,  7)
    ...
    BattleInfo(
        "BattleInfo_5C4", 0x0000, 50, 6, 60, 8, 1, 25, 0, "br1000", "Sepith_3F3A", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_68C", 0x0000, 50, 6, 60, 8, 1, 25, 0, "br1000", "Sepith_3F42", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_754", 0x0000, 50, 6, 60, 8, 1, 25, 0, "br1000", "Sepith_3F82", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_81C", 0x0000, 50, 6, 60, 8, 1, 30, 0, "br1000", "Sepith_3F7A", 30, 40, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_8E4", 0x0000, 84, 6, 60, 6, 1, 30, 0, "br1000", "Sepith_3F92", 40, 35, 25, 0,
        (
    ...
    ScpFunction((
        ...
        "Function_5_1DD8",         # 05, 5
        "Function_6_1F13",         # 06, 6
        "Function_7_223D",         # 07, 7
        "Function_8_2567",         # 08, 8
        "Function_9_2580",         # 09, 9
        "Function_10_2584",        # 0A, 10
        "Function_11_263C",        # 0B, 11
        "Function_12_276F",        # 0C, 12
        "Function_13_27C0",        # 0D, 13
        "Function_14_2854",        # 0E, 14
        "Function_15_2B81",        # 0F, 15
        "Function_16_2D49",        # 10, 16
        "Function_17_31BB",        # 11, 17
        "Function_18_32DF",        # 12, 18
        "Function_19_3336",        # 13, 19
        "Function_20_3992",        # 14, 20
        "Function_21_39F7",        # 15, 21
        "Function_22_3A5C",        # 16, 22
        "Function_23_3AC1",        # 17, 23
        "Function_24_3ADA",        # 18, 24
        "Function_25_3DA6",        # 19, 25
        "Function_26_3E45",        # 1A, 26
        "Function_27_3EAE",        # 1B, 27
    ))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1E2, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1D8F")
    Sound(14, 0, 100, 0)
    OP_74(0x1, 0x1E)
    OP_71(0x1, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x20B, 1)"), scpexpr(EXPR_END)), "loc_1D20")
    ...
    def Function_5_1DD8(): pass

    label("Function_5_1DD8")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1E2, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1ECA")
    Sound(14, 0, 100, 0)
    OP_74(0x2, 0x1E)
    OP_71(0x2, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber(0x1FB, 1)"), scpexpr(EXPR_END)), "loc_1E5B")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_6_1F13(): pass

    label("Function_6_1F13")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_20B1")
    TalkBegin(0xFF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x3A, 0)), scpexpr(EXPR_END)), "loc_2092")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_208D")
    ClearScenarioFlags(0x3A, 0)
    OP_65(0x3, 0x1)
    StopEffect(0x9, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 0)), scpexpr(EXPR_END)), "loc_208A")
    ClearScenarioFlags(0x38, 0)
    ...
    QueueWorkItem(0xD, 2, lambda_1FB5)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2085")
    RunExpression(0x0, (scpexpr(EXPR_RAND), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_206C")
    Call(1, 5)
    Jump("loc_2085")

    label("loc_206C")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_2082")
    Call(1, 4)
    Jump("loc_2085")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 0)), scpexpr(EXPR_END)), "loc_20A8")
    ClearScenarioFlags(0x38, 0)
    OP_65(0x3, 0x1)
    StopEffect(0x9, 0x2)
    Call(1, 0)
    ...
    TalkBegin(0xFF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x3A, 0)), scpexpr(EXPR_END)), "loc_2222")
    LoadEffect(0x7, "event\\eva07_00.eff")
    ...
    OP_65(0x3, 0x1)
    StopEffect(0x9, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 0)), scpexpr(EXPR_END)), "loc_221A")
    ClearScenarioFlags(0x38, 0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2215")
    RunExpression(0x0, (scpexpr(EXPR_RAND), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_21FC")
    Call(1, 5)
    Jump("loc_2215")

    label("loc_21FC")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_2212")
    Call(1, 4)
    Jump("loc_2215")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 0)), scpexpr(EXPR_END)), "loc_2238")
    ClearScenarioFlags(0x38, 0)
    OP_65(0x3, 0x1)
    StopEffect(0x9, 0x2)
    Call(1, 0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_23DB")
    TalkBegin(0xFF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x3A, 1)), scpexpr(EXPR_END)), "loc_23BC")
    LoadEffect(0x7, "event\\eva07_00.eff")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_23B7")
    ClearScenarioFlags(0x3A, 1)
    OP_65(0x4, 0x1)
    StopEffect(0xA, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 1)), scpexpr(EXPR_END)), "loc_23B4")
    ClearScenarioFlags(0x38, 1)
    ...
    QueueWorkItem(0xE, 2, lambda_22DF)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_23AF")
    RunExpression(0x0, (scpexpr(EXPR_RAND), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_2396")
    Call(1, 5)
    Jump("loc_23AF")

    label("loc_2396")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_23AC")
    Call(1, 4)
    Jump("loc_23AF")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 1)), scpexpr(EXPR_END)), "loc_23D2")
    ClearScenarioFlags(0x38, 1)
    OP_65(0x4, 0x1)
    StopEffect(0xA, 0x2)
    Call(1, 0)
    ...
    TalkBegin(0xFF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x3A, 1)), scpexpr(EXPR_END)), "loc_254C")
    LoadEffect(0x7, "event\\eva07_00.eff")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2547")
    ClearScenarioFlags(0x3A, 1)
    OP_65(0x4, 0x1)
    StopEffect(0xA, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 1)), scpexpr(EXPR_END)), "loc_2544")
    ClearScenarioFlags(0x38, 1)
    ...
    QueueWorkItem(0x10, 2, lambda_246F)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_253F")
    RunExpression(0x0, (scpexpr(EXPR_RAND), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_2526")
    Call(1, 5)
    Jump("loc_253F")

    label("loc_2526")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_253C")
    Call(1, 4)
    Jump("loc_253F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x38, 1)), scpexpr(EXPR_END)), "loc_2562")
    ClearScenarioFlags(0x38, 1)
    OP_65(0x4, 0x1)
    StopEffect(0xA, 0x2)
    Call(1, 0)
    ...
    def Function_8_2567(): pass

    label("Function_8_2567")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_257F")
    ...
    def Function_9_2580(): pass

    label("Function_9_2580")
    ...
    def Function_10_2584(): pass

    label("Function_10_2584")
    ...
    OP_57(0x0)
    OP_5A()
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2614")
    Call(0, 11)
    ClearMapFlags(0x8000000)
    ...
    # Function_10_2584 end

    def Function_11_263C(): pass

    label("Function_11_263C")

    ClearMapFlags(0x1)
    SetEventSkip(0x0, "loc_276B")
    Fade(500)
    ...
    QueueWorkItem(0x8, 1, lambda_2722)
    OP_0D()
    Sound(466, 0, 100, 0)
    Sound(467, 0, 100, 0)
    WaitChrThread(0x8, 1)
    ...
    # Function_11_263C end

    def Function_12_276F(): pass

    label("Function_12_276F")
    ...
    # Function_12_276F end

    def Function_13_27C0(): pass

    label("Function_13_27C0")
    ...
    Sound(492, 0, 70, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x31, 2)), scpexpr(EXPR_END)), "loc_281B")
    Jc((scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x64), scpexpr(EXPR_IMOD), scpexpr(EXPR_PUSH_LONG, 0x32), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_2810")
    ...
    Jc((scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x64), scpexpr(EXPR_IMOD), scpexpr(EXPR_PUSH_LONG, 0x32), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_2839")
    ...
    Jc((scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x64), scpexpr(EXPR_IMOD), scpexpr(EXPR_PUSH_LONG, 0x32), scpexpr(EXPR_LSS), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x182, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2886")
    SetScenarioFlags(0x31, 2)

    label("loc_2886")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_28CC")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x31, 2)), scpexpr(EXPR_END)), "loc_28C6")
    Jc((scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0x64), scpexpr(EXPR_IMOD), scpexpr(EXPR_PUSH_LONG, 0x32), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_28BB")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2B73")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x20, 5)), scpexpr(EXPR_END)), "loc_293D")
    MenuCmd(0, 0)
    MenuCmd(1, 0, "登上梅尔卡瓦")
    MenuCmd(1, 0, "放弃")
    MenuCmd(2, 0, -1, -1, 1)
    ...
    MenuCmd(0, 0)
    MenuCmd(1, 0, "驾驶导力车移动")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 6)), scpexpr(EXPR_END)), "loc_296D")
    MenuCmd(1, 0, "在导力车中休息")
    ...
    OP_74(0x3, 0x1E)
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_29C8")
    OP_70(0x3, 0x12C)
    ...
    FadeToDark(300, 0, -1)
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "MiniGame(0x2E, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0)"), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2A2E")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    FadeToDark(0, 0, -1)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1D4, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2A51")
    Sound(461, 0, 100, 0)

    label("loc_2A51")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_2A71")
    OP_70(0x3, 0x14A)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 6)), scpexpr(EXPR_END)), "loc_2B0D")
    OP_57(0x0)
    StopBGM(0xBB8)
    FadeToDark(1000, 0, -1)
    OP_0D()
    OP_5A()
    Sound(13, 0, 100, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x31, 0)), scpexpr(EXPR_END)), "loc_2AD0")
    OP_32(0xFF, 0xFF, 0x0)
    Jump("loc_2AE8")

    label("loc_2AD0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 7)), scpexpr(EXPR_END)), "loc_2AE3")
    OP_32(0xFF, 0xFE, 0x0)
    Jump("loc_2AE8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 7)), scpexpr(EXPR_END)), "loc_2B1D")
    OP_AF(0xFB)
    Jump("loc_2B27")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2B45")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_2B5F")

    label("loc_2B45")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x30, 7)), scpexpr(EXPR_END)), "loc_2B55")
    OP_AF(0xFB)
    Jump("loc_2B5F")
    ...
    def Function_15_2B81(): pass

    label("Function_15_2B81")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x126, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x128, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2CA2")
    EventBegin(0x2)
    ClearMapFlags(0x20)
    SetChrName("")
    ...
    ChrTalk(
        0x101,
        (
            "#00000F我们还是步行去警察学校吧，\x01",
            "也算是不错的运动。\x02",
        )
    )

    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x12D, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2C9F")
    Sound(814, 0, 100, 0)
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x162, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x164, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2D0F")
    EventBegin(0x2)
    ClearMapFlags(0x20)
    SetChrName("")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1A0, 0)), scpexpr(EXPR_END)), "loc_2D45")
    EventBegin(0x2)
    ClearMapFlags(0x20)
    SetChrName("")
    ...
    # Function_15_2B81 end

    def Function_16_2D49(): pass

    label("Function_16_2D49")
    ...
    QueueWorkItem(0x101, 0, lambda_2DE0)
    Sleep(0)
    ...
    QueueWorkItem(0x102, 0, lambda_2DF8)
    Sleep(0)
    ...
    QueueWorkItem(0x109, 0, lambda_2E10)
    Sleep(0)
    ...
    QueueWorkItem(0x105, 0, lambda_2E28)
    Sleep(0)
    ...
    QueueWorkItem(0x109, 0, lambda_2E5D)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 0, lambda_2E6D)
    Sleep(100)
    WaitChrThread(0x109, 0)
    WaitChrThread(0x102, 0)
    ...
    QueueWorkItem(0x109, 0, lambda_2FEA)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 0, lambda_2FFA)
    Sleep(50)
    WaitChrThread(0x109, 0)
    WaitChrThread(0x102, 0)
    ...
    ChrTalk(
        0x102,
        (
            "#00102F#11P呵呵，那我们\x01",
            "就徒步出发吧。\x02\x03",

            "#00100F在路上也许会遇到通缉魔兽，\x01",
            "一定要小心些。\x02",
        )
    )
    ...
    # Function_16_2D49 end

    def Function_17_31BB(): pass

    label("Function_17_31BB")
    ...
    # Function_17_31BB end

    def Function_18_32DF(): pass

    label("Function_18_32DF")
    ...
    # Function_18_32DF end

    def Function_19_3336(): pass

    label("Function_19_3336")
    ...
    QueueWorkItem(0x101, 1, lambda_353B)
    ...
    QueueWorkItem(0x103, 1, lambda_356F)

    def lambda_3589():
        OP_95(0xFE, -96400, -2000, 12850, 2000, 0x0)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_3589)

    def lambda_35A3():
        OP_95(0xFE, -96150, -2000, 14400, 2000, 0x0)
        ExitThread()

    QueueWorkItem(0x109, 1, lambda_35A3)

    def lambda_35BD():
        OP_95(0xFE, -95150, -2000, 12700, 2000, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_35BD)
    Sleep(2500)
    Sound(467, 0, 100, 0)
    ...
    # Function_19_3336 end

    def Function_20_3992(): pass

    label("Function_20_3992")
    ...
    # Function_20_3992 end

    def Function_21_39F7(): pass

    label("Function_21_39F7")
    ...
    # Function_21_39F7 end

    def Function_22_3A5C(): pass

    label("Function_22_3A5C")
    ...
    # Function_22_3A5C end

    def Function_23_3AC1(): pass

    label("Function_23_3AC1")
    ...
    # Function_23_3AC1 end

    def Function_24_3ADA(): pass

    label("Function_24_3ADA")
    ...
    # Function_24_3ADA end

    def Function_25_3DA6(): pass

    label("Function_25_3DA6")
    ...
    # Function_25_3DA6 end

    def Function_26_3E45(): pass

    label("Function_26_3E45")
    ...
    # Function_26_3E45 end

    def Function_27_3EAE(): pass

    label("Function_27_3EAE")
