...
def main():
    ...
    Sepith("Sepith_6ED", 19,  0,   0,   10,  10,  8,   8)
    Sepith("Sepith_715", 9,   9,   9,   21,  4,   4,   4)
    ...
    BattleInfo(
        "BattleInfo_238", 0x0000, 90, 6, 60, 6, 1, 25, 0, "bm1020", "Sepith_6ED", 40, 30, 20, 10,
        (
    ...
    BattleInfo(
        "BattleInfo_300", 0x0000, 90, 6, 60, 6, 1, 30, 0, "bm1020", "Sepith_715", 40, 30, 20, 10,
        (
    ...
    OP_60(0x0)
    OP_57(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_6B6")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_74(0x0, 0x1E)
