...
def main():
    ...
    OP_5A()
    OP_6F(0x1)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_4C8")
    OP_E2(0x2)
    ...
    def Function_4_4CD(): pass

    label("Function_4_4CD")
    ...
    QueueWorkItem(0x101, 0, lambda_78C)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 0, lambda_7A9)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 0, lambda_7C6)
    Sleep(50)
    ...
    QueueWorkItem(0x109, 0, lambda_7E3)
    Sleep(50)
    ...
    QueueWorkItem(0x105, 0, lambda_800)
    Sleep(50)
    ...
    QueueWorkItem(0x10A, 0, lambda_81D)
    ...
    QueueWorkItem(0x104, 2, lambda_8A7)
    ...
    QueueWorkItem(0x109, 2, lambda_8CC)
    ...
    QueueWorkItem(0x10A, 2, lambda_916)
    Sleep(1000)
    ...
    QueueWorkItem(0xFE, 1, lambda_C08)
    ...
    QueueWorkItem(0xFE, 1, lambda_C2F)
    Sleep(900)
    OP_4B(0xFE, 0x0)
