...
def main():
    ...
    ATBonus("ATBonus_1B4", 100, 5, 1, 5, 1, 5, 1, 5, 5, 0, 0, 0, 1, 0, 0, 0)

    Sepith("Sepith_A12", 5,   5,   5,   5,   5,   5,   5)

    MonsterBattlePostion("MonsterBattlePostion_1F4", 7, 9, 180)
    MonsterBattlePostion("MonsterBattlePostion_1F8", 11, 10, 180)
    MonsterBattlePostion("MonsterBattlePostion_1FC", 10, 13, 180)
    MonsterBattlePostion("MonsterBattlePostion_200", 5, 11, 180)
    MonsterBattlePostion("MonsterBattlePostion_204", 12, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_208", 4, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_20C", 14, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_210", 2, 13, 180)
    MonsterBattlePostion("MonsterBattlePostion_274", 7, 4, 0)
    MonsterBattlePostion("MonsterBattlePostion_278", 10, 11, 225)
    MonsterBattlePostion("MonsterBattlePostion_27C", 4, 7, 90)
    MonsterBattlePostion("MonsterBattlePostion_280", 12, 7, 270)
    MonsterBattlePostion("MonsterBattlePostion_284", 4, 11, 135)
    MonsterBattlePostion("MonsterBattlePostion_288", 11, 4, 315)
    MonsterBattlePostion("MonsterBattlePostion_28C", 7, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_290", 5, 5, 45)
    MonsterBattlePostion("MonsterBattlePostion_214", 8, 8, 180)
    MonsterBattlePostion("MonsterBattlePostion_218", 5, 9, 180)
    MonsterBattlePostion("MonsterBattlePostion_21C", 11, 10, 180)
    MonsterBattlePostion("MonsterBattlePostion_220", 6, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_224", 10, 12, 180)
    MonsterBattlePostion("MonsterBattlePostion_228", 13, 13, 180)
    MonsterBattlePostion("MonsterBattlePostion_22C", 4, 14, 180)
    MonsterBattlePostion("MonsterBattlePostion_230", 8, 14, 180)

    # monster count: 4

    BattleInfo(
        "BattleInfo_294", 0x0000, 84, 6, 60, 8, 1, 60, 0, "br1060", "Sepith_A12", 45, 35, 20, 0,
        (
            ("ms80801.dat", "ms80801.dat", 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_1F4", "MonsterBattlePostion_274", "ed7450", "ed7453", "ATBonus_1B4"),
            ("ms80801.dat", "ms80801.dat", "ms80801.dat", 0, 0, 0, 0, 0, "MonsterBattlePostion_214", "MonsterBattlePostion_274", "ed7450", "ed7453", "ATBonus_1B4"),
            ("ms80801.dat", "ms80801.dat", "ms80801.dat", "ms80801.dat", 0, 0, 0, 0, "MonsterBattlePostion_1F4", "MonsterBattlePostion_274", "ed7450", "ed7453", "ATBonus_1B4"),
            (),
        )
    )
    ...
    DeclMonster(-17720,  -1550,   0,       0x101014E,    "BattleInfo_294", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-42100,  8330,    0,       0x10100C8,    "BattleInfo_294", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-61000,  -7260,   0,       0x1010122,    "BattleInfo_294", 0,   16,  0xFFFF, 0,  1)
    DeclMonster(-85910,  9960,    0,       0x10100AF,    "BattleInfo_294", 0,   16,  0xFFFF, 0,  1)

    DeclActor(-72020,  0,       -12550,  1200,    -72020,  1000,    -12550,  0x007C, 0,  2,  0x0000)
    DeclActor(18590,   0,       11190,   1200,    18590,   1000,    11190,   0x007C, 0,  3,  0x0000)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1A7, 1)), scpexpr(EXPR_END)), "loc_367")
    OP_E2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x183, 4)), scpexpr(EXPR_END)), "loc_37A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F9, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6BE")
    OP_70(0x3, 0x0)
    Jump("loc_6C2")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F9, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6D5")
    OP_70(0x4, 0x0)
    Jump("loc_6D9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F9, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_802")
    Sound(14, 0, 100, 0)
    OP_74(0x3, 0x1E)
    OP_71(0x3, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber('大回复药', 1)"), scpexpr(EXPR_END)), "loc_793")
    ...
    def Function_3_84B(): pass

    label("Function_3_84B")

    OP_F4(0x1)
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x1F9, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_93D")
    Sound(14, 0, 100, 0)
    OP_74(0x4, 0x1E)
    OP_71(0x4, 0x0, 0x1E, 0x0, 0x0)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "AddItemNumber('超能跑鞋', 1)"), scpexpr(EXPR_END)), "loc_8CE")
    FadeToDark(300, 0, 100)
    Sound(17, 0, 100, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_4_986(): pass

    label("Function_4_986")
